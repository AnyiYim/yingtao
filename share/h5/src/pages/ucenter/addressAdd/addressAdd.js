...
var z = [];
  (function(z){
    ...
    Z([3, 'add-address']);Z([3, 'add-form']);Z([3, '100%']);Z([3, 'form-item']);Z([3, 'bindinputName']);Z([3, 'input']);Z([3, '姓名']);Z([[6],[[7],[3, "address"]],[3, "full_name"]]);Z([3, 'bindinputMobile']);Z([3, '手机号码']);Z([[6],[[7],[3, "address"]],[3, "phone_number"]]);Z([3, 'chooseRegion']);Z([3, 'true']);Z([3, '省份、城市、区县']);Z([[6],[[7],[3, "address"]],[3, "line4"]]);Z([3, 'blurFocus']);Z([3, 'getfocus']);Z([3, 'bindinputAddress']);Z([3, '详细地址, 如街道、楼盘号等']);Z([[6],[[7],[3, "address"]],[3, "line1"]]);Z([3, 'form-default']);Z([3, 'bindIsDefault']);Z([a, [3, 'default-input '],[[2,'?:'],[[2, "=="], [[6],[[7],[3, "address"]],[3, "is_default_for_shipping"]], [1, 1]],[1, "selected"],[1, ""]]]);Z([3, '设为默认地址']);Z([a, [3, 'btns '],[[2,'?:'],[[2, "=="], [[7],[3, "btnsite"]], [1, "options0"]],[1, "opcity-btn"],[1, ""]]]);Z([3, 'cancelAddress']);Z([3, 'cannel']);Z([3, '取消']);Z([3, 'saveAddress']);Z([3, 'save']);Z([3, '保存']);Z([[7],[3, "openSelectRegion"]]);Z([3, 'region-select']);Z([3, 'hd']);Z([3, 'region-selected']);Z([[7],[3, "selectRegionList"]]);Z([[6],[[7],[3, "item"]],[3, "id"]]);Z([3, 'selectRegionType']);Z([a, [3, 'item '],[[2,'?:'],[[2, "=="], [[6],[[7],[3, "item"]],[3, "id"]], [1, 0]],[1, "disabled"],[1, ""]],[3, ' '],[[2,'?:'],[[2, "==="], [[2, "-"], [[7],[3, "regionType"]], [1, 1]], [[7],[3, "index"]]],[1, "selected"],[1, ""]]]);Z([[7],[3, "index"]]);Z([a, [[6],[[7],[3, "item"]],[3, "name"]]]);Z([3, 'doneSelectRegion']);Z([a, [3, 'done '],[[2,'?:'],[[7],[3, "selectRegionDone"]],[1, ""],[1, "disabled"]]]);Z([3, '确定']);Z([3, 'bd']);Z([3, 'region-list']);Z([[7],[3, "regionList"]]);Z([3, 'selectRegion']);Z([a, [3, 'item '],[[2,'?:'],[[6],[[7],[3, "item"]],[3, "selected"]],[1, "selected"],[1, ""]]]);Z([3, 'cancelSelectRegion']);Z([3, 'bg-mask']);
  })(z);d_["./pages/ucenter/addressAdd/addressAdd.wxml"] = {};
  var m0=function(e,s,r,gg){
    var o_V = _n("view");_r(o_V, 'class', 0, e, s, gg);var oAW = _m( "view", ["class", 1,"height", 1], e, s, gg);var oBW = _n("view");_r(oBW, 'class', 3, e, s, gg);var oCW = _m( "input", ["bindinput", 4,"class", 1,"placeholder", 2,"value", 3], e, s, gg);_(oBW,oCW);_(oAW,oBW);var oDW = _n("view");_r(oDW, 'class', 3, e, s, gg);var oEW = _m( "input", ["class", 5,"bindinput", 3,"placeholder", 4,"value", 5], e, s, gg);_(oDW,oEW);_(oAW,oDW);var oFW = _n("view");_r(oFW, 'class', 3, e, s, gg);var oGW = _m( "input", ["class", 5,"bindtap", 6,"disabled", 7,"placeholder", 8,"value", 9], e, s, gg);_(oFW,oGW);_(oAW,oFW);var oHW = _n("view");_r(oHW, 'class', 3, e, s, gg);var oIW = _m( "input", ["class", 5,"bindblur", 10,"bindfocus", 11,"bindinput", 12,"placeholder", 13,"value", 14], e, s, gg);_(oHW,oIW);_(oAW,oHW);var oJW = _n("view");_r(oJW, 'class', 20, e, s, gg);var oKW = _m( "text", ["bindtap", 21,"class", 1], e, s, gg);var oLW = _o(23, e, s, gg);_(oKW,oLW);_(oJW,oKW);_(oAW,oJW);_(o_V,oAW);var oMW = _n("view");_r(oMW, 'class', 24, e, s, gg);var oNW = _m( "button", ["bindtap", 25,"class", 1], e, s, gg);var oOW = _o(27, e, s, gg);_(oNW,oOW);_(oMW,oNW);var oPW = _m( "button", ["bindtap", 28,"class", 1], e, s, gg);var oQW = _o(30, e, s, gg);_(oPW,oQW);_(oMW,oPW);_(o_V,oMW);var oRW = _v();
      if (_o(31, e, s, gg)) {
        oRW.wxVkey = 1;var oSW = _n("view");_r(oSW, 'class', 32, e, s, gg);var oUW = _n("view");_r(oUW, 'class', 33, e, s, gg);var oVW = _n("view");_r(oVW, 'class', 34, e, s, gg);var oWW = _v();var oXW = function(obW,oaW,oZW,gg){var oYW = _m( "view", ["bindtap", 37,"class", 1,"data-region-type-index", 2], obW, oaW, gg);var odW = _o(40, obW, oaW, gg);_(oYW,odW);_(oZW, oYW);return oZW;};_2(35, oXW, e, s, gg, oWW, "item", "index", '{{item.id}}');_(oVW,oWW);_(oUW,oVW);var oeW = _m( "view", ["bindtap", 41,"class", 1], e, s, gg);var ofW = _o(43, e, s, gg);_(oeW,ofW);_(oUW,oeW);_(oSW,oUW);var ogW = _n("view");_r(ogW, 'class', 44, e, s, gg);var ohW = _n("view");_r(ohW, 'class', 45, e, s, gg);var oiW = _v();var ojW = function(onW,omW,olW,gg){var okW = _m( "view", ["data-region-index", 39,"bindtap", 8,"class", 9], onW, omW, gg);var opW = _o(40, onW, omW, gg);_(okW,opW);_(olW, okW);return olW;};_2(46, ojW, e, s, gg, oiW, "item", "index", '{{item.id}}');_(ohW,oiW);_(ogW,ohW);_(oSW,ogW);_(oRW, oSW);
      } _(o_V,oRW);_(r,o_V);var oqW = _v();
      if (_o(31, e, s, gg)) {
        oqW.wxVkey = 1;var orW = _m( "view", ["bindtap", 49,"class", 1], e, s, gg);_(oqW, orW);
      } _(r,oqW);
    return r;
  };
        e_["./pages/ucenter/addressAdd/addressAdd.wxml"]={f:m0,j:[],i:[],ti:[],ic:[]};
if(path&&e_[path]){
...
if(typeof(window.__webview_engine_version__)=='undefined'||window.__webview_engine_version__+1e-6<0.01+1e-6){return _ev(root);}}catch(err){console.log(err)}return root;}}}@code-separator-line:body{height:100%;background:#f4f4f4}.add-address .add-form{height:100%;background:#fff;width:100%;overflow:hidden}.add-address .form-item{height:%%?116rpx?%%;padding-left:%%?31.25rpx?%%;border-bottom:1px solid #d9d9d9;display:flex;align-items:center;padding-right:%%?31.25rpx?%%}.add-address .input{flex:1;height:%%?44rpx?%%;line-height:%%?44rpx?%%;overflow:hidden}.add-address .form-default{border-bottom:1px solid #d9d9d9;height:%%?96rpx?%%;background:#fafafa;padding-top:%%?28rpx?%%;font-size:%%?28rpx?%%}.default-input{margin:0 auto;display:block;width:%%?240rpx?%%;height:%%?40rpx?%%;padding-left:%%?50rpx?%%;line-height:%%?40rpx?%%;background:url(http://yanxuan.nosdn.127.net/hxm/yanxuan-wap/p/20161201/style/img/sprites/checkbox-sed825af9d3-a6b8540d42.png) %%?1rpx?%% %%?-446rpx?%% no-repeat;background-size:%%?38rpx?%% %%?486rpx?%%;font-size:%%?28rpx?%%}.default-input.selected{background:url(http://yanxuan.nosdn.127.net/hxm/yanxuan-wap/p/20161201/style/img/sprites/checkbox-sed825af9d3-a6b8540d42.png) 0 %%?-188rpx?%% no-repeat;background-size:%%?38rpx?%% %%?486rpx?%%}.add-address .btns{position:fixed;bottom:0;left:0;overflow:hidden;display:flex;height:%%?100rpx?%%;width:100%}.add-address .cannel,.add-address .save{flex:1;height:%%?100rpx?%%;text-align:center;line-height:%%?100rpx?%%;font-size:%%?28rpx?%%;color:#fff;border:none;border-radius:0}.add-address .cannel{background:#333}.add-address .save{background:#b4282d}.region-select{width:100%;height:%%?600rpx?%%;background:#fff;position:fixed;z-index:10;left:0;bottom:0}.region-select .hd{height:%%?108rpx?%%;width:100%;border-bottom:1px solid #f4f4f4;padding:%%?46rpx?%% %%?30rpx?%% 0 %%?30rpx?%%}.region-select .region-selected{float:left;height:%%?60rpx?%%;display:flex}.region-select .region-selected .item{max-width:%%?140rpx?%%;margin-right:%%?30rpx?%%;text-align:left;line-height:%%?60rpx?%%;height:100%;color:#333;font-size:%%?28rpx?%%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.region-select .region-selected .item.disabled{color:#999}.region-select .region-selected .item.selected{color:#b4282d}.region-select .done{float:right;height:%%?60rpx?%%;width:%%?60rpx?%%;border:none;background:#fff;line-height:%%?60rpx?%%;text-align:center;color:#333;font-size:%%?28rpx?%%}.region-select .done.disabled{color:#999}.region-select .bd{height:%%?492rpx?%%;width:100%;padding:0 %%?30rpx?%%;overflow:scroll}.region-select .region-list{height:auto;overflow:scroll}.region-select .region-list .item{width:100%;height:%%?104rpx?%%;line-height:%%?104rpx?%%;text-align:left;color:#333;font-size:%%?28rpx?%%}.region-select .region-list .item.selected{color:#b4282d}.bg-mask{height:100%;width:100%;background:rgba(0,0,0,.4);position:fixed;top:42px;left:0;z-index:8}.opcity-btn{opacity:0}@code-separator-line:__wxRoute = "pages/ucenter/addressAdd/addressAdd";__wxRouteBegin = true;
define("pages/ucenter/addressAdd/addressAdd.js", function(require, module, exports, window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,fetch,XMLHttpRequest,WebSocket,webkit,WeixinJSCore,ServiceJSBridge,Reporter){
...
Page({
  data: {
    ...
    selectRegionList: [
      { id: 0, name: '省份', parent_id: 0, type: 1 },
  ...
  bindinputName: function (e) {
    ...
    let address = this.data.address;
    address.full_name = e.detail.value;
    return {
      address: address,
  ...
  checkdata: function(){
      wx.showToast({
          title: this.data.address.full_name
      });
  },
...
});require("pages/ucenter/addressAdd/addressAdd.js")@code-separator-line:["div","view","input","text","button"]