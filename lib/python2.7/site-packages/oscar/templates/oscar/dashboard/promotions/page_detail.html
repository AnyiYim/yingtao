                ...
                <tbody class="promotion_list">
                    {% for promotion in position.promotions %}
                        <tr id="promo_{{ promotion.pk }}">
                            <td><a href="{% url 'dashboard:promotion-update' ptype=promotion.content_object.code pk=promotion.pk %}">{{ promotion.content_object.name }}</a></td>
                                ...
                                <div class="btn-toolbar">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="{% url 'dashboard:promotion-update' ptype=promotion.content_object.code pk=promotion.content_object.id %}">{% trans "Edit" %}</a></li>
                                            <li><a href="{% url 'dashboard:pagepromotion-delete' pk=promotion.id %}">{% trans "Remove" %}</a></li>
                                        </ul>
                                    </div>
                                    <a href="#" class="btn btn-info btn-handle">
                                        <i class="icon-move icon-large"></i>
                                        {% trans "Change display order" %}
                                    </a>
                                </div>
                            </td>
                        </tr>
