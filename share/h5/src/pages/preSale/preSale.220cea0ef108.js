...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var o_I = _n("view");_r(o_I, 'class', 0, e, s, gg);var oAJ = _n("view");_r(oAJ, 'class', 1, e, s, gg);var oBJ = _n("view");_r(oBJ, 'class', 2, e, s, gg);var oCJ = _n("view");_r(oCJ, 'class', 3, e, s, gg);var oDJ = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oCJ,oDJ);_(oBJ,oCJ);var oEJ = _n("view");_r(oEJ, 'class', 6, e, s, gg);var oFJ = _n("view");_r(oFJ, 'class', 7, e, s, gg);var oGJ = _o(8, e, s, gg);_(oFJ,oGJ);_(oEJ,oFJ);_(oBJ,oEJ);_(oAJ,oBJ);_(o_I,oAJ);var oHJ = _n("view");_r(oHJ, 'class', 9, e, s, gg);var oIJ = _n("view");_r(oIJ, 'class', 10, e, s, gg);var oJJ = _v();var oKJ = function(oOJ,oNJ,oMJ,gg){var oQJ = _n("view");_r(oQJ, 'class', 15, oOJ, oNJ, gg);var oRJ = _m( "navigator", ["class", 16,"url", 1], oOJ, oNJ, gg);var oSJ = _n("view");_r(oSJ, 'class', 18, oOJ, oNJ, gg);var oTJ = _m( "image", ["backgroundSize", 19,"class", 1,"src", 2], oOJ, oNJ, gg);_(oSJ,oTJ);_(oRJ,oSJ);var oUJ = _n("view");_r(oUJ, 'class', 22, oOJ, oNJ, gg);var oVJ = _n("view");_r(oVJ, 'class', 23, oOJ, oNJ, gg);var oWJ = _o(24, oOJ, oNJ, gg);_(oVJ,oWJ);_(oUJ,oVJ);var oXJ = _n("view");_r(oXJ, 'class', 25, oOJ, oNJ, gg);var oYJ = _o(26, oOJ, oNJ, gg);_(oXJ,oYJ);_(oUJ,oXJ);var oZJ = _n("view");_r(oZJ, 'class', 27, oOJ, oNJ, gg);var oaJ = _n("view");_r(oaJ, 'class', 28, oOJ, oNJ, gg);var obJ = _m( "image", ["class", 29,"src", 1], oOJ, oNJ, gg);_(oaJ,obJ);var ocJ = _m( "image", ["class", 31,"src", 1], oOJ, oNJ, gg);_(oaJ,ocJ);_(oZJ,oaJ);var odJ = _n("view");_r(odJ, 'class', 33, oOJ, oNJ, gg);var oeJ = _o(34, oOJ, oNJ, gg);_(odJ,oeJ);_(oZJ,odJ);_(oUJ,oZJ);var ofJ = _n("view");_r(ofJ, 'class', 35, oOJ, oNJ, gg);var ogJ = _n("view");_r(ogJ, 'class', 36, oOJ, oNJ, gg);var ohJ = _n("view");_r(ohJ, 'class', 37, oOJ, oNJ, gg);var oiJ = _m( "image", ["class", 38,"src", 1], oOJ, oNJ, gg);_(ohJ,oiJ);_(ogJ,ohJ);var ojJ = _n("view");_r(ojJ, 'class', 40, oOJ, oNJ, gg);var okJ = _o(41, oOJ, oNJ, gg);_(ojJ,okJ);_(ogJ,ojJ);_(ofJ,ogJ);var olJ = _n("view");_r(olJ, 'class', 42, oOJ, oNJ, gg);var omJ = _o(43, oOJ, oNJ, gg);_(olJ,omJ);_(ofJ,olJ);_(oUJ,ofJ);_(oRJ,oUJ);_(oQJ,oRJ);_(oMJ,oQJ);return oMJ;};_2(11, oKJ, e, s, gg, oJJ, "item", "index", '{{item.id}}');_(oIJ,oJJ);_(oHJ,oIJ);var onJ = _m( "view", ["class", 10,"style", 34], e, s, gg);_(oHJ,onJ);_(o_I,oHJ);_(r,o_I);
    return r;
  };
