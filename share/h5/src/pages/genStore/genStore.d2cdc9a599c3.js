...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oNG = _n("view");_r(oNG, 'class', 0, e, s, gg);var oOG = _n("view");_r(oOG, 'class', 1, e, s, gg);var oPG = _n("view");_r(oPG, 'class', 2, e, s, gg);var oQG = _n("view");var oRG = _m( "image", ["class", 3,"src", 1], e, s, gg);_(oQG,oRG);_(oPG,oQG);_(oOG,oPG);var oSG = _n("view");_r(oSG, 'class', 5, e, s, gg);var oTG = _n("view");_r(oTG, 'class', 6, e, s, gg);var oUG = _o(7, e, s, gg);_(oTG,oUG);_(oSG,oTG);var oVG = _n("view");_r(oVG, 'class', 8, e, s, gg);var oWG = _n("view");_r(oWG, 'class', 9, e, s, gg);var oXG = _m( "image", ["class", 10,"src", 1], e, s, gg);_(oWG,oXG);_(oVG,oWG);var oYG = _n("view");_r(oYG, 'class', 12, e, s, gg);var oZG = _o(13, e, s, gg);_(oYG,oZG);_(oVG,oYG);_(oSG,oVG);_(oOG,oSG);_(oNG,oOG);var oaG = _n("view");_r(oaG, 'class', 14, e, s, gg);var obG = _m( "scroll-view", ["class", 15,"scrollLeft", 1,"scrollX", 2,"style", 3], e, s, gg);var ocG = _v();var odG = function(ohG,ogG,ofG,gg){var oeG = _m( "view", ["bindtap", 20,"class", 1,"data-barclassactivate", 2], ohG, ogG, gg);var ojG = _o(23, ohG, ogG, gg);_(oeG,ojG);_(ofG, oeG);return ofG;};_2(19, odG, e, s, gg, ocG, "item", "index", '');_(obG,ocG);_(oaG,obG);_(oNG,oaG);var okG = _n("view");_r(okG, 'class', 24, e, s, gg);var olG = _v();
      if (_o(25, e, s, gg)) {
        olG.wxVkey = 1;var omG = _n("view");_r(omG, 'class', 26, e, s, gg);var ooG = _n("view");_r(ooG, 'class', 27, e, s, gg);var opG = _n("view");_r(opG, 'class', 28, e, s, gg);var oqG = _o(29, e, s, gg);_(opG,oqG);var orG = _v();var osG = function(owG,ovG,ouG,gg){var otG = _m( "navigator", ["class", 31,"url", 2], owG, ovG, gg);var oyG = _m( "image", ["backgroundSize", 34,"class", 1,"src", 2], owG, ovG, gg);_(otG,oyG);var ozG = _n("text");_r(ozG, 'class', 37, owG, ovG, gg);var o_G = _o(38, owG, ovG, gg);_(ozG,o_G);_(otG,ozG);var oAH = _n("text");_r(oAH, 'class', 39, owG, ovG, gg);var oBH = _o(40, owG, ovG, gg);_(oAH,oBH);_(otG,oAH);_(ouG, otG);return ouG;};_2(30, osG, e, s, gg, orG, "item", "index", '');_(opG,orG);_(ooG,opG);_(omG,ooG);_(olG, omG);
      } _(okG,olG);var oCH = _v();
      if (_o(41, e, s, gg)) {
        oCH.wxVkey = 1;var oDH = _n("view");_r(oDH, 'class', 42, e, s, gg);var oFH = _m( "image", ["class", 43,"src", 1], e, s, gg);_(oDH,oFH);var oGH = _n("text");_r(oGH, 'class', 45, e, s, gg);var oHH = _o(46, e, s, gg);_(oGH,oHH);_(oDH,oGH);_(oCH, oDH);
      } _(okG,oCH);_(oNG,okG);_(r,oNG);
    return r;
  };
