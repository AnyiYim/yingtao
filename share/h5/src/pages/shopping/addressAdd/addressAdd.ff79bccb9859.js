...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var ofN = _n("view");_r(ofN, 'class', 0, e, s, gg);var ogN = _n("view");_r(ogN, 'class', 1, e, s, gg);var ohN = _n("view");_r(ohN, 'class', 2, e, s, gg);var oiN = _m( "input", ["bindinput", 3,"class", 1,"placeholder", 2,"value", 3], e, s, gg);_(ohN,oiN);_(ogN,ohN);var ojN = _n("view");_r(ojN, 'class', 2, e, s, gg);var okN = _m( "input", ["class", 4,"bindinput", 3,"placeholder", 4,"value", 5], e, s, gg);_(ojN,okN);_(ogN,ojN);var olN = _n("view");_r(olN, 'class', 2, e, s, gg);var omN = _m( "input", ["class", 4,"bindtap", 6,"disabled", 7,"placeholder", 8,"value", 9], e, s, gg);_(olN,omN);_(ogN,olN);var onN = _n("view");_r(onN, 'class', 2, e, s, gg);var ooN = _m( "input", ["class", 4,"bindblur", 10,"bindfocus", 11,"bindinput", 12,"placeholder", 13,"value", 14], e, s, gg);_(onN,ooN);_(ogN,onN);var opN = _n("view");_r(opN, 'class', 19, e, s, gg);var oqN = _m( "text", ["bindtap", 20,"class", 1], e, s, gg);var orN = _o(22, e, s, gg);_(oqN,orN);_(opN,oqN);_(ogN,opN);_(ofN,ogN);var osN = _n("view");_r(osN, 'class', 23, e, s, gg);var otN = _m( "button", ["bindtap", 24,"class", 1], e, s, gg);var ouN = _o(26, e, s, gg);_(otN,ouN);_(osN,otN);var ovN = _m( "button", ["bindtap", 27,"class", 1], e, s, gg);var owN = _o(29, e, s, gg);_(ovN,owN);_(osN,ovN);_(ofN,osN);var oxN = _v();
      if (_o(30, e, s, gg)) {
        oxN.wxVkey = 1;var oyN = _n("view");_r(oyN, 'class', 31, e, s, gg);var o_N = _n("view");_r(o_N, 'class', 32, e, s, gg);var oAO = _n("view");_r(oAO, 'class', 33, e, s, gg);var oBO = _v();var oCO = function(oGO,oFO,oEO,gg){var oDO = _m( "view", ["bindtap", 36,"class", 1,"data-region-type-index", 2], oGO, oFO, gg);var oIO = _o(39, oGO, oFO, gg);_(oDO,oIO);_(oEO, oDO);return oEO;};_2(34, oCO, e, s, gg, oBO, "item", "index", '{{item.id}}');_(oAO,oBO);_(o_N,oAO);var oJO = _m( "view", ["bindtap", 40,"class", 1], e, s, gg);var oKO = _o(42, e, s, gg);_(oJO,oKO);_(o_N,oJO);_(oyN,o_N);var oLO = _n("view");_r(oLO, 'class', 43, e, s, gg);var oMO = _n("view");_r(oMO, 'class', 44, e, s, gg);var oNO = _v();var oOO = function(oSO,oRO,oQO,gg){var oPO = _m( "view", ["data-region-index", 38,"bindtap", 8,"class", 9], oSO, oRO, gg);var oUO = _o(39, oSO, oRO, gg);_(oPO,oUO);_(oQO, oPO);return oQO;};_2(45, oOO, e, s, gg, oNO, "item", "index", '{{item.id}}');_(oMO,oNO);_(oLO,oMO);_(oyN,oLO);_(oxN, oyN);
      } _(ofN,oxN);_(r,ofN);var oVO = _v();
      if (_o(30, e, s, gg)) {
        oVO.wxVkey = 1;var oWO = _m( "view", ["bindtap", 48,"class", 1], e, s, gg);_(oVO, oWO);
      } _(r,oVO);
    return r;
  };
