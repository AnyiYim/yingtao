...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oML = _n("view");_r(oML, 'class', 0, e, s, gg);var oNL = _n("view");_r(oNL, 'class', 1, e, s, gg);var oOL = _n("view");_r(oOL, 'class', 2, e, s, gg);var oPL = _n("view");_r(oPL, 'class', 3, e, s, gg);var oQL = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oPL,oQL);_(oOL,oPL);var oRL = _n("view");_r(oRL, 'class', 6, e, s, gg);var oSL = _n("view");_r(oSL, 'class', 7, e, s, gg);var oTL = _o(8, e, s, gg);_(oSL,oTL);_(oRL,oSL);_(oOL,oRL);_(oNL,oOL);_(oML,oNL);var oUL = _n("view");_r(oUL, 'class', 9, e, s, gg);var oVL = _n("view");_r(oVL, 'class', 10, e, s, gg);var oWL = _v();var oXL = function(obL,oaL,oZL,gg){var odL = _n("view");_r(odL, 'class', 15, obL, oaL, gg);var oeL = _m( "navigator", ["class", 16,"url", 1], obL, oaL, gg);var ofL = _n("view");_r(ofL, 'class', 18, obL, oaL, gg);var ogL = _m( "image", ["backgroundSize", 19,"class", 1,"src", 2], obL, oaL, gg);_(ofL,ogL);_(oeL,ofL);var ohL = _n("view");_r(ohL, 'class', 22, obL, oaL, gg);var oiL = _n("view");_r(oiL, 'class', 23, obL, oaL, gg);var ojL = _o(24, obL, oaL, gg);_(oiL,ojL);_(ohL,oiL);var okL = _n("view");_r(okL, 'class', 25, obL, oaL, gg);var olL = _o(26, obL, oaL, gg);_(okL,olL);_(ohL,okL);var omL = _n("view");_r(omL, 'class', 27, obL, oaL, gg);var onL = _n("view");_r(onL, 'class', 28, obL, oaL, gg);var ooL = _m( "image", ["class", 29,"src", 1], obL, oaL, gg);_(onL,ooL);var opL = _m( "image", ["class", 31,"src", 1], obL, oaL, gg);_(onL,opL);_(omL,onL);var oqL = _n("view");_r(oqL, 'class', 33, obL, oaL, gg);var orL = _o(34, obL, oaL, gg);_(oqL,orL);_(omL,oqL);_(ohL,omL);var osL = _n("view");_r(osL, 'class', 35, obL, oaL, gg);var otL = _n("view");_r(otL, 'class', 36, obL, oaL, gg);var ouL = _n("view");_r(ouL, 'class', 37, obL, oaL, gg);var ovL = _m( "image", ["class", 38,"src", 1], obL, oaL, gg);_(ouL,ovL);_(otL,ouL);var owL = _n("view");_r(owL, 'class', 40, obL, oaL, gg);var oxL = _o(41, obL, oaL, gg);_(owL,oxL);_(otL,owL);_(osL,otL);var oyL = _n("view");_r(oyL, 'class', 42, obL, oaL, gg);var ozL = _o(43, obL, oaL, gg);_(oyL,ozL);_(osL,oyL);_(ohL,osL);_(oeL,ohL);_(odL,oeL);_(oZL,odL);return oZL;};_2(11, oXL, e, s, gg, oWL, "item", "index", '{{item.id}}');_(oVL,oWL);_(oUL,oVL);var o_L = _m( "view", ["class", 10,"style", 34], e, s, gg);_(oUL,o_L);_(oML,oUL);_(r,oML);
    return r;
  };
