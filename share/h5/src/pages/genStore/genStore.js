...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var owI = _n("view");_r(owI, 'class', 0, e, s, gg);var oxI = _n("view");_r(oxI, 'class', 1, e, s, gg);var oyI = _n("view");_r(oyI, 'class', 2, e, s, gg);var ozI = _n("view");var o_I = _m( "image", ["class", 3,"src", 1], e, s, gg);_(ozI,o_I);_(oyI,ozI);_(oxI,oyI);var oAJ = _n("view");_r(oAJ, 'class', 5, e, s, gg);var oBJ = _n("view");_r(oBJ, 'class', 6, e, s, gg);var oCJ = _o(7, e, s, gg);_(oBJ,oCJ);_(oAJ,oBJ);var oDJ = _n("view");_r(oDJ, 'class', 8, e, s, gg);var oEJ = _n("view");_r(oEJ, 'class', 9, e, s, gg);var oFJ = _m( "image", ["class", 10,"src", 1], e, s, gg);_(oEJ,oFJ);_(oDJ,oEJ);var oGJ = _n("view");_r(oGJ, 'class', 12, e, s, gg);var oHJ = _o(13, e, s, gg);_(oGJ,oHJ);_(oDJ,oGJ);_(oAJ,oDJ);_(oxI,oAJ);_(owI,oxI);var oIJ = _n("view");_r(oIJ, 'class', 14, e, s, gg);var oJJ = _m( "scroll-view", ["class", 15,"scrollLeft", 1,"scrollX", 2,"style", 3], e, s, gg);var oKJ = _v();var oLJ = function(oPJ,oOJ,oNJ,gg){var oMJ = _m( "view", ["bindtap", 20,"class", 1,"data-barclassactivate", 2], oPJ, oOJ, gg);var oRJ = _o(23, oPJ, oOJ, gg);_(oMJ,oRJ);_(oNJ, oMJ);return oNJ;};_2(19, oLJ, e, s, gg, oKJ, "item", "index", '');_(oJJ,oKJ);_(oIJ,oJJ);_(owI,oIJ);var oSJ = _n("view");_r(oSJ, 'class', 24, e, s, gg);var oTJ = _v();
      if (_o(25, e, s, gg)) {
        oTJ.wxVkey = 1;var oUJ = _n("view");_r(oUJ, 'class', 26, e, s, gg);var oWJ = _n("view");_r(oWJ, 'class', 27, e, s, gg);var oXJ = _n("view");_r(oXJ, 'class', 28, e, s, gg);var oYJ = _o(29, e, s, gg);_(oXJ,oYJ);var oZJ = _v();var oaJ = function(oeJ,odJ,ocJ,gg){var obJ = _m( "navigator", ["class", 31,"url", 2], oeJ, odJ, gg);var ogJ = _m( "image", ["backgroundSize", 34,"class", 1,"src", 2], oeJ, odJ, gg);_(obJ,ogJ);var ohJ = _n("text");_r(ohJ, 'class', 37, oeJ, odJ, gg);var oiJ = _o(38, oeJ, odJ, gg);_(ohJ,oiJ);_(obJ,ohJ);var ojJ = _n("text");_r(ojJ, 'class', 39, oeJ, odJ, gg);var okJ = _o(40, oeJ, odJ, gg);_(ojJ,okJ);_(obJ,ojJ);_(ocJ, obJ);return ocJ;};_2(30, oaJ, e, s, gg, oZJ, "item", "index", '');_(oXJ,oZJ);_(oWJ,oXJ);_(oUJ,oWJ);_(oTJ, oUJ);
      } _(oSJ,oTJ);var olJ = _v();
      if (_o(41, e, s, gg)) {
        olJ.wxVkey = 1;var omJ = _n("view");_r(omJ, 'class', 42, e, s, gg);var ooJ = _m( "image", ["class", 43,"src", 1], e, s, gg);_(omJ,ooJ);var opJ = _n("text");_r(opJ, 'class', 45, e, s, gg);var oqJ = _o(46, e, s, gg);_(opJ,oqJ);_(omJ,opJ);_(olJ, omJ);
      } _(oSJ,olJ);_(owI,oSJ);_(r,owI);
    return r;
  };
