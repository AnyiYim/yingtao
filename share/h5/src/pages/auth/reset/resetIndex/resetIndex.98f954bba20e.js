...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oEC = _n("view");_r(oEC, 'class', 0, e, s, gg);var oFC = _n("view");_r(oFC, 'class', 1, e, s, gg);_(oEC,oFC);var oGC = _n("view");_r(oGC, 'class', 2, e, s, gg);var oHC = _n("view");_r(oHC, 'class', 3, e, s, gg);var oIC = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oHC,oIC);_(oGC,oHC);var oJC = _n("view");_r(oJC, 'class', 6, e, s, gg);var oKC = _n("view");_r(oKC, 'class', 7, e, s, gg);var oLC = _o(8, e, s, gg);_(oKC,oLC);_(oJC,oKC);_(oGC,oJC);_(oEC,oGC);var oMC = _n("view");_r(oMC, 'class', 9, e, s, gg);var oNC = _n("view");_r(oNC, 'class', 10, e, s, gg);var oOC = _m( "input", ["bindinput", 11,"class", 1,"placeholder", 2], e, s, gg);_(oNC,oOC);var oPC = _v();
      if (_o(14, e, s, gg)) {
        oPC.wxVkey = 1;var oQC = _m( "image", ["catchtap", 15,"class", 1,"id", 2,"src", 3], e, s, gg);_(oPC, oQC);
      } _(oNC,oPC);_(oMC,oNC);var oSC = _n("view");_r(oSC, 'class', 19, e, s, gg);var oTC = _n("view");_r(oTC, 'class', 20, e, s, gg);var oUC = _m( "input", ["bindinput", 21,"class", 1,"placeholder", 2,"value", 3], e, s, gg);_(oTC,oUC);var oVC = _v();
      if (_o(25, e, s, gg)) {
        oVC.wxVkey = 1;var oWC = _m( "image", ["catchtap", 15,"class", 1,"src", 3,"id", 11], e, s, gg);_(oVC, oWC);
      } _(oTC,oVC);_(oSC,oTC);var oYC = _m( "button", ["bindtap", 27,"class", 1,"disabled", 2,"size", 3,"type", 4], e, s, gg);var oZC = _o(32, e, s, gg);_(oYC,oZC);_(oSC,oYC);_(oMC,oSC);var oaC = _m( "button", ["bindtap", 33,"class", 1,"type", 2], e, s, gg);var obC = _o(36, e, s, gg);_(oaC,obC);_(oMC,oaC);_(oEC,oMC);_(r,oEC);
    return r;
  };
