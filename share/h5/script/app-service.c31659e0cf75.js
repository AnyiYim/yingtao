...
// const ApiRootUrl = 'http://www.yt131.com/';
const ApiRootUrl = 'http://127.0.0.1:8000/';
// const ApiRootUrl = 'http://192.168.0.107:8000/';
// const ApiRootUrl = 'http://third.alpha.liubao.com/';

// const ApiRootUrl = 'http://alpha.liubao.com/';


module.exports = {
  // Host: 'http://www.yt131.com',
  // SSL: 'http://www.yt131.com',
  SSL: 'http://127.0.0.1:8000',
  ...
  UploadImage: ApiRootUrl + "api/upload/image/",
  ...
  Promotions: ApiRootUrl + 'api/promotions/',
  PromotionsProducts: ApiRootUrl + 'api/promotions/{id}/products/',
  BestSaleGoods: ApiRootUrl + 'api/promotions/bestsale/{id}',
  PromotionActivate: ApiRootUrl + 'api/promotions/activate/',
...
function login(mobile, password, vcode=''){
    return new Promise(function (resolve, reject) {
        ...
        util.request('/api/auth/', data, 'POST').then((res) => {
            resolve(res);
        }).catch((err) => {
        });
    });
...
function get_reset_vcode(mobile){
    return new Promise(function (resolve, reject) {
        util.request('/api/vcode/password/'+ mobile + '/').then((res) => {
            resolve(res);
        }).catch((err) => {
...
function reset_password(mobile, code, password){
    return new Promise(function (resolve, reject) {
        util.request('/api/user/password/'+ mobile + '/',
        {
...
function get_register_vcode(mobile){
    return new Promise(function (resolve, reject) {
        util.request('/api/user/' + mobile + '/', {}, 'POST').then((res) => {
            resolve(res);
        }).catch((err) => {
        });
    });
...
function register_with_vcode(mobile, vcode, password){
    return new Promise(function (resolve, reject) {
        ...
        util.request('/api/user/', data, 'POST').then((res) => {
            resolve(res);
        }).catch((err) => {
        });
    });
...
function get_userinfo() {
    return new Promise(function (resolve, reject) {
        util.request('/api/user/', {}, 'GET', tip=false).then((res) => {
            resolve(res);
        }).catch((err) => {
        });
    });
...
function get_vary_mobile_vcode(mobile){
    return new Promise(function (resolve, reject) {
        util.request('/api/user/varymobile/' + mobile + '/', {}, 'POST').then((res) => {
            resolve(res);
        }).catch((err) => {
        });
    });
...
function vary_mobile_with_vcode(mobile, vcode, password, method='POST'){
    return new Promise(function (resolve, reject) {
        ...
        util.request('/api/user/varymobile/', data, method).then((res) => {
            resolve(res);
        }).catch((err) => {
        });
    });
...
function logout(){
    return new Promise(function (resolve, reject) {
        util.request('/api/auth/logout/', {}, 'GET').then((res) => {
            resolve(res);
        }).catch((err) => {
        });
    });
