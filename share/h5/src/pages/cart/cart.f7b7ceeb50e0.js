...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oeE = _n("view");_r(oeE, 'class', 0, e, s, gg);var ofE = _n("view");_r(ofE, 'class', 1, e, s, gg);var ogE = _m( "view", ["bindtap", 2,"class", 1,"data-type01", 2], e, s, gg);var ohE = _o(5, e, s, gg);_(ogE,ohE);_(ofE,ogE);var oiE = _m( "view", ["bindtap", 2,"class", 4,"data-type01", 5], e, s, gg);var ojE = _o(8, e, s, gg);_(oiE,ojE);_(ofE,oiE);_(oeE,ofE);var okE = _n("view");_r(okE, 'class', 9, e, s, gg);_(oeE,okE);var olE = _v();
      if (_o(10, e, s, gg)) {
        olE.wxVkey = 1;var omE = _n("view");_r(omE, 'class', 11, e, s, gg);var ooE = _n("view");_r(ooE, 'class', 12, e, s, gg);var opE = _n("image");_r(opE, 'src', 13, e, s, gg);_(ooE,opE);var oqE = _n("text");var orE = _o(14, e, s, gg);_(oqE,orE);_(ooE,oqE);_(omE,ooE);_(olE, omE);
      } _(oeE,olE);var osE = _v();
      if (_o(15, e, s, gg)) {
        osE.wxVkey = 1;var otE = _n("view");_r(otE, 'class', 16, e, s, gg);var ovE = _n("view");_r(ovE, 'class', 17, e, s, gg);var owE = _n("view");_r(owE, 'class', 18, e, s, gg);var oxE = _n("view");_r(oxE, 'class', 19, e, s, gg);var oyE = _v();var ozE = function(oCF,oBF,oAF,gg){var o_E = _n("view");var oEF = _n("view");_r(oEF, 'class', 22, oCF, oBF, gg);_(o_E,oEF);var oFF = _m( "scroll-view", ["class", 23,"scrollLeft", 1,"scrollX", 2], oCF, oBF, gg);var oGF = _n("view");_r(oGF, 'class', 26, oCF, oBF, gg);var oHF = _m( "view", ["bindtap", 27,"class", 1,"data-item-index", 2], oCF, oBF, gg);_(oGF,oHF);_(oFF,oGF);var oIF = _m( "navigator", ["class", 30,"url", 1], oCF, oBF, gg);var oJF = _m( "image", ["class", 32,"src", 1], oCF, oBF, gg);_(oIF,oJF);var oKF = _n("view");_r(oKF, 'class', 34, oCF, oBF, gg);var oLF = _n("view");_r(oLF, 'class', 35, oCF, oBF, gg);var oMF = _n("text");_r(oMF, 'class', 36, oCF, oBF, gg);var oNF = _o(37, oCF, oBF, gg);_(oMF,oNF);_(oLF,oMF);_(oKF,oLF);var oOF = _n("view");_r(oOF, 'class', 38, oCF, oBF, gg);var oPF = _o(39, oCF, oBF, gg);_(oOF,oPF);_(oKF,oOF);var oQF = _n("view");_r(oQF, 'class', 40, oCF, oBF, gg);var oRF = _n("text");_r(oRF, 'class', 41, oCF, oBF, gg);var oSF = _o(42, oCF, oBF, gg);_(oRF,oSF);_(oQF,oRF);var oTF = _n("view");_r(oTF, 'class', 43, oCF, oBF, gg);var oUF = _m( "view", ["data-item-index", 29,"catchtap", 15,"class", 16], oCF, oBF, gg);var oVF = _o(46, oCF, oBF, gg);_(oUF,oVF);_(oTF,oUF);var oWF = _m( "input", ["disabled", 25,"class", 22,"type", 22,"value", 23], oCF, oBF, gg);_(oTF,oWF);var oXF = _m( "view", ["data-item-index", 29,"catchtap", 20,"class", 21], oCF, oBF, gg);var oYF = _o(51, oCF, oBF, gg);_(oXF,oYF);_(oTF,oXF);_(oQF,oTF);_(oKF,oQF);_(oIF,oKF);_(oFF,oIF);var oZF = _m( "view", ["data-item-index", 29,"bindtap", 23,"class", 24], oCF, oBF, gg);var oaF = _m( "view", ["data-item-index", 29,"class", 25], oCF, oBF, gg);var obF = _o(55, oCF, oBF, gg);_(oaF,obF);_(oZF,oaF);_(oFF,oZF);_(o_E,oFF);_(oAF, o_E);return oAF;};_2(20, ozE, e, s, gg, oyE, "item", "index", '{{item.id}}');_(oxE,oyE);_(owE,oxE);_(ovE,owE);_(otE,ovE);var ocF = _n("view");_r(ocF, 'class', 56, e, s, gg);var odF = _m( "view", ["bindtap", 57,"class", 1], e, s, gg);var oeF = _o(59, e, s, gg);_(odF,oeF);_(ocF,odF);var ofF = _m( "view", ["class", 52,"bindtap", 8], e, s, gg);var ogF = _o(61, e, s, gg);_(ofF,ogF);_(ocF,ofF);var ohF = _n("view");_r(ohF, 'class', 62, e, s, gg);var oiF = _o(63, e, s, gg);_(ohF,oiF);_(ocF,ohF);var ojF = _v();
      if (_o(64, e, s, gg)) {
        ojF.wxVkey = 1;var okF = _m( "view", ["bindtap", 65,"class", 1], e, s, gg);var omF = _o(67, e, s, gg);_(okF,omF);_(ojF, okF);
      } _(ocF,ojF);var onF = _v();
      if (_o(68, e, s, gg)) {
        onF.wxVkey = 1;var ooF = _m( "view", ["class", 66,"bindtap", 3], e, s, gg);var oqF = _o(70, e, s, gg);_(ooF,oqF);_(onF, ooF);
      } _(ocF,onF);_(otE,ocF);_(osE, otE);
      } _(oeE,osE);_(r,oeE);
    return r;
  };
