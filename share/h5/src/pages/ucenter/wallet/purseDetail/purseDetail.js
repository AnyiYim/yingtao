...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var ook = _n("view");_r(ook, 'class', 0, e, s, gg);var opk = _n("view");_r(opk, 'class', 1, e, s, gg);var oqk = _m( "scroll-view", ["class", 2,"scrollLeft", 1,"scrollX", 2,"style", 3], e, s, gg);var ork = _v();var osk = function(owk,ovk,ouk,gg){var otk = _m( "view", ["class", 8,"data-index", 1], owk, ovk, gg);var oyk = _n("view");_r(oyk, 'class', 10, owk, ovk, gg);var ozk = _o(11, owk, ovk, gg);_(oyk,ozk);_(otk,oyk);_(ouk, otk);return ouk;};_2(6, osk, e, s, gg, ork, "item", "index", '');_(oqk,ork);_(opk,oqk);_(ook,opk);var o_k = _n("view");_r(o_k, 'class', 12, e, s, gg);var oAl = _n("view");_r(oAl, 'class', 13, e, s, gg);_(o_k,oAl);var oBl = _n("view");_r(oBl, 'class', 14, e, s, gg);var oCl = _v();var oDl = function(oHl,oGl,oFl,gg){var oEl = _n("view");_r(oEl, 'class', 17, oHl, oGl, gg);var oJl = _n("view");_r(oJl, 'class', 18, oHl, oGl, gg);var oKl = _n("view");_r(oKl, 'class', 19, oHl, oGl, gg);var oLl = _n("view");_r(oLl, 'class', 20, oHl, oGl, gg);var oMl = _o(21, oHl, oGl, gg);_(oLl,oMl);_(oKl,oLl);var oNl = _n("view");_r(oNl, 'class', 22, oHl, oGl, gg);var oOl = _o(23, oHl, oGl, gg);_(oNl,oOl);_(oKl,oNl);_(oJl,oKl);var oPl = _n("view");_r(oPl, 'class', 24, oHl, oGl, gg);var oQl = _o(25, oHl, oGl, gg);_(oPl,oQl);_(oJl,oPl);_(oEl,oJl);_(oFl, oEl);return oFl;};_2(15, oDl, e, s, gg, oCl, "item", "index", '{{item.id}}');_(oBl,oCl);_(o_k,oBl);_(ook,o_k);_(r,ook);
    return r;
  };
