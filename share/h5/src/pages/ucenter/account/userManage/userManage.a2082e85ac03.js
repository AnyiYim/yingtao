...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var ocQ = _n("view");_r(ocQ, 'class', 0, e, s, gg);var odQ = _n("view");_r(odQ, 'class', 1, e, s, gg);_(ocQ,odQ);var oeQ = _m( "view", ["bindtap", 2,"class", 1], e, s, gg);var ofQ = _n("view");_r(ofQ, 'class', 4, e, s, gg);var ogQ = _o(5, e, s, gg);_(ofQ,ogQ);_(oeQ,ofQ);var ohQ = _n("view");_r(ohQ, 'class', 6, e, s, gg);var oiQ = _n("view");_r(oiQ, 'class', 7, e, s, gg);var ojQ = _m( "image", ["class", 8,"src", 1], e, s, gg);_(oiQ,ojQ);_(ohQ,oiQ);var okQ = _n("view");_r(okQ, 'class', 7, e, s, gg);var olQ = _m( "image", ["class", 10,"src", 1], e, s, gg);_(okQ,olQ);_(ohQ,okQ);_(oeQ,ohQ);_(ocQ,oeQ);var omQ = _n("view");_r(omQ, 'class', 1, e, s, gg);_(ocQ,omQ);var onQ = _n("view");_r(onQ, 'class', 12, e, s, gg);var ooQ = _m( "navigator", ["class", 13,"url", 1], e, s, gg);var opQ = _m( "view", ["bindtap", 15,"class", 1], e, s, gg);var oqQ = _n("view");_r(oqQ, 'class', 17, e, s, gg);var orQ = _o(18, e, s, gg);_(oqQ,orQ);_(opQ,oqQ);var osQ = _n("view");_r(osQ, 'class', 19, e, s, gg);var otQ = _v();
      if (_o(20, e, s, gg)) {
        otQ.wxVkey = 1;var ouQ = _n("view");_r(ouQ, 'class', 21, e, s, gg);var owQ = _o(22, e, s, gg);_(ouQ,owQ);_(otQ, ouQ);
      }else {
        otQ.wxVkey = 2;var oxQ = _n("view");_r(oxQ, 'class', 21, e, s, gg);var ozQ = _o(23, e, s, gg);_(oxQ,ozQ);_(otQ, oxQ);
      }_(osQ,otQ);var o_Q = _n("view");_r(o_Q, 'class', 24, e, s, gg);var oAR = _m( "image", ["class", 10,"src", 1], e, s, gg);_(o_Q,oAR);_(osQ,o_Q);_(opQ,osQ);_(ooQ,opQ);_(onQ,ooQ);var oBR = _m( "navigator", ["class", 13,"url", 12], e, s, gg);var oCR = _n("view");_r(oCR, 'class', 16, e, s, gg);var oDR = _n("view");_r(oDR, 'class', 17, e, s, gg);var oER = _o(26, e, s, gg);_(oDR,oER);_(oCR,oDR);var oFR = _n("view");_r(oFR, 'class', 19, e, s, gg);var oGR = _n("view");_r(oGR, 'class', 21, e, s, gg);var oHR = _o(27, e, s, gg);_(oGR,oHR);_(oFR,oGR);var oIR = _n("view");_r(oIR, 'class', 24, e, s, gg);var oJR = _m( "image", ["class", 10,"src", 1], e, s, gg);_(oIR,oJR);_(oFR,oIR);_(oCR,oFR);_(oBR,oCR);_(onQ,oBR);var oKR = _n("view");_r(oKR, 'class', 1, e, s, gg);_(onQ,oKR);var oLR = _n("view");_r(oLR, 'class', 28, e, s, gg);var oMR = _n("view");_r(oMR, 'class', 29, e, s, gg);var oNR = _m( "view", ["bindtap", 30,"class", 1], e, s, gg);var oOR = _m( "image", ["class", 32,"src", 1], e, s, gg);_(oNR,oOR);_(oMR,oNR);_(oLR,oMR);var oPR = _n("view");_r(oPR, 'class', 34, e, s, gg);var oQR = _m( "view", ["bindtap", 35,"class", 1], e, s, gg);var oRR = _o(37, e, s, gg);_(oQR,oRR);_(oPR,oQR);_(oLR,oPR);_(onQ,oLR);_(ocQ,onQ);_(r,ocQ);
    return r;
  };
