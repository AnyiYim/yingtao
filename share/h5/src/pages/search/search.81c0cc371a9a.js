...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oMI = _n("view");_r(oMI, 'class', 0, e, s, gg);var oNI = _n("view");_r(oNI, 'class', 1, e, s, gg);var oOI = _n("view");_r(oOI, 'class', 2, e, s, gg);var oPI = _m( "image", ["class", 3,"src", 1], e, s, gg);_(oOI,oPI);var oQI = _m( "input", ["bindconfirm", 5,"bindfocus", 1,"bindinput", 2,"class", 3,"confirmType", 4,"confirmType", 4,"name", 5,"placeholder", 6,"value", 7], e, s, gg);_(oOI,oQI);var oRI = _v();
      if (_o(12, e, s, gg)) {
        oRI.wxVkey = 1;var oSI = _m( "image", ["bindtap", 13,"class", 1,"src", 2], e, s, gg);_(oRI, oSI);
      } _(oOI,oRI);_(oNI,oOI);var oUI = _m( "view", ["bindtap", 16,"class", 1], e, s, gg);var oVI = _o(18, e, s, gg);_(oUI,oVI);_(oNI,oUI);_(oMI,oNI);var oWI = _n("scroll-view");var oXI = _v();
      if (_o(19, e, s, gg)) {
        oXI.wxVkey = 1;var oYI = _n("view");_r(oYI, 'class', 20, e, s, gg);var oaI = _n("view");_r(oaI, 'class', 21, e, s, gg);var obI = _n("view");_r(obI, 'class', 22, e, s, gg);var ocI = _v();var odI = function(ohI,ogI,ofI,gg){var oeI = _m( "navigator", ["class", 26,"url", 1], ohI, ogI, gg);var ojI = _m( "image", ["backgroundSize", 28,"class", 1,"src", 2], ohI, ogI, gg);_(oeI,ojI);var okI = _n("text");_r(okI, 'class', 31, ohI, ogI, gg);var olI = _o(32, ohI, ogI, gg);_(okI,olI);_(oeI,okI);var omI = _n("text");_r(omI, 'class', 33, ohI, ogI, gg);var onI = _o(34, ohI, ogI, gg);_(omI,onI);_(oeI,omI);_(ofI, oeI);return ofI;};_2(23, odI, e, s, gg, ocI, "iitem", "iindex", '');_(obI,ocI);_(oaI,obI);_(oYI,oaI);_(oXI, oYI);
      } _(oWI,oXI);var ooI = _v();
      if (_o(35, e, s, gg)) {
        ooI.wxVkey = 1;var opI = _n("view");_r(opI, 'class', 36, e, s, gg);var orI = _n("view");_r(orI, 'class', 37, e, s, gg);var osI = _o(38, e, s, gg);_(orI,osI);_(opI,orI);_(ooI, opI);
      } _(oWI,ooI);var otI = _v();
      if (_o(39, e, s, gg)) {
        otI.wxVkey = 1;var ouI = _n("view");_r(ouI, 'class', 40, e, s, gg);var owI = _m( "image", ["class", 3,"src", 38], e, s, gg);_(ouI,owI);var oxI = _n("text");_r(oxI, 'class', 42, e, s, gg);var oyI = _o(43, e, s, gg);_(oxI,oyI);_(ouI,oxI);_(otI, ouI);
      } _(oWI,otI);_(oMI,oWI);_(r,oMI);
    return r;
  };
