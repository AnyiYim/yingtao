...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var ohU = _n("view");_r(ohU, 'class', 0, e, s, gg);var oiU = _v();
      if (_o(1, e, s, gg)) {
        oiU.wxVkey = 1;var ojU = _n("navigator");_r(ojU, 'url', 2, e, s, gg);var olU = _n("view");_r(olU, 'class', 3, e, s, gg);var omU = _n("view");_r(omU, 'class', 4, e, s, gg);var onU = _n("view");_r(onU, 'class', 5, e, s, gg);var ooU = _o(6, e, s, gg);_(onU,ooU);_(omU,onU);_(olU,omU);var opU = _n("view");_r(opU, 'class', 7, e, s, gg);var oqU = _m( "image", ["class", 8,"src", 1], e, s, gg);_(opU,oqU);_(olU,opU);_(ojU,olU);_(oiU, ojU);
      } _(ohU,oiU);var orU = _n("view");_r(orU, 'bindtap', 10, e, s, gg);var osU = _m( "image", ["class", 11,"src", 1], e, s, gg);_(orU,osU);_(ohU,orU);var otU = _n("view");_r(otU, 'class', 13, e, s, gg);var ouU = _o(14, e, s, gg);_(otU,ouU);_(ohU,otU);var ovU = _n("view");_r(ovU, 'class', 15, e, s, gg);var owU = _o(16, e, s, gg);_(ovU,owU);_(ohU,ovU);var oxU = _n("view");_r(oxU, 'class', 17, e, s, gg);var oyU = _v();var ozU = function(oCV,oBV,oAV,gg){var o_U = _n("view");_r(o_U, 'class', 20, oCV, oBV, gg);var oEV = _n("view");_r(oEV, 'class', 21, oCV, oBV, gg);var oFV = _n("view");_r(oFV, 'class', 22, oCV, oBV, gg);var oGV = _m( "image", ["class", 11,"src", 12], oCV, oBV, gg);_(oFV,oGV);_(oEV,oFV);var oHV = _n("view");_r(oHV, 'class', 24, oCV, oBV, gg);var oIV = _n("view");_r(oIV, 'class', 25, oCV, oBV, gg);var oJV = _o(26, oCV, oBV, gg);_(oIV,oJV);_(oHV,oIV);var oKV = _n("view");_r(oKV, 'class', 27, oCV, oBV, gg);var oLV = _o(28, oCV, oBV, gg);_(oKV,oLV);_(oHV,oKV);_(oEV,oHV);_(o_U,oEV);var oMV = _n("view");_r(oMV, 'class', 29, oCV, oBV, gg);var oNV = _n("view");_r(oNV, 'class', 30, oCV, oBV, gg);var oOV = _o(31, oCV, oBV, gg);_(oNV,oOV);_(oMV,oNV);var oPV = _n("view");_r(oPV, 'class', 32, oCV, oBV, gg);var oQV = _o(33, oCV, oBV, gg);_(oPV,oQV);_(oMV,oPV);_(o_U,oMV);_(oAV, o_U);return oAV;};_2(18, ozU, e, s, gg, oyU, "item", "index", '{{item.mobile}}');_(oxU,oyU);_(ohU,oxU);_(r,ohU);
    return r;
  };
...
Page({
    ...
    share_qrcode: function(){
        let that = this
        util.request(api.WxConfigSign, {url:(api.SSL+'/static/h5/index.html')}, 'GET').then(function(res){
            if(res.code === 0){
                wx_share.config ({
                ...
                var shareData = {
                    ...
                    "link" : (api.SSL+'/accounts/share-qrcode/?img_url='+that.data.Host + that.data.scan_img),
                    "desc" : '点开链接扫码',   // 分享描述
