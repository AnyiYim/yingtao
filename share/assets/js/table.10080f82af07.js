...
var title = {
    '乐享券资金': {'create_time':'创建日期', 'order_number':'订单号', 'uid':'客户ID',
        'pay_amount':'支付金额', 'total_consume_bonus':'30天分红累计',
        'coupons':'乐享券', 'consume_detail':'30天分红详情'},
    '销售订单': {'number':'订单编号', 'payer_id':'客户ID', 'total_fee':'商品金额',
    ...
    '30天消费分红表': {'data_date':'日期', 'create_time':'创建日期', 'order_number':'订单编号',
        'uid':'客户ID', 'amount':'支付金额', 'pf_total_amount':'总累计销售额',
        'ratio':'占比', 'pf_bonus_consume':'消费分红总计', 'bonus':'应付分红'},

    '体验包分红表': {'data_date':'日期', 'create_time':'创建日期', 'order_number':'订单编号',
    ...
    '产品推荐奖计算表': {'create_time':'创建日期',  'order_number':'订单编号',
...
var title_english = {
    '乐享券资金': ['create_time', 'order_number', 'uid', 'pay_amount',
        'total_consume_bonus', 'coupons', 'consume_detail'],

    '销售订单': ['number', 'payer_id', 'total_fee', 'amount', 'new_store_bonus',
    ...
    '30天消费分红表': ['data_date', 'create_time', 'order_number', 'uid', 'amount', 'pf_total_amount',
        'ratio', 'pf_bonus_consume', 'bonus'],

    '体验包分红表': ['data_date', 'create_time', 'order_number', 'uid', 'amount', 'prev_gen1_uid',
    ...
    '产品推荐奖计算表': ['create_time',  'order_number','recommend_uid', 'bonus'],
...
var no_format_whitelist = ['create_time', 'coupons', 'prev_gen1_lv',
    'pre_gen2_lv', 'order_number', 'pf_create_time', 'finish_time', 'data_date',
    'level', 'x', 'y']
var page_size = 50;
var page_num = 0;
var offset = 0;
...
var coupons_everyday_bonus_rander = function(data, time){
    ...
    for(var i=0; i<daily_bonus.length; i++){
        ...
        value = '￥' + daily_bonus[i].toLocaleString();
        td_bonus.html(value);
