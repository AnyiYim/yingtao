...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var ouW = _n("view");_r(ouW, 'class', 0, e, s, gg);var ovW = _n("view");_r(ovW, 'class', 1, e, s, gg);var owW = _m( "view", ["class", 2,"style", 1], e, s, gg);var oxW = _n("view");_r(oxW, 'class', 4, e, s, gg);var oyW = _o(5, e, s, gg);_(oxW,oyW);_(owW,oxW);var ozW = _n("view");_r(ozW, 'class', 6, e, s, gg);var o_W = _o(7, e, s, gg);_(ozW,o_W);_(owW,ozW);_(ovW,owW);var oAX = _m( "view", ["class", 2,"style", 6], e, s, gg);var oBX = _n("view");_r(oBX, 'class', 4, e, s, gg);var oCX = _o(9, e, s, gg);_(oBX,oCX);_(oAX,oBX);var oDX = _n("view");_r(oDX, 'class', 6, e, s, gg);var oEX = _o(10, e, s, gg);_(oDX,oEX);_(oAX,oDX);_(ovW,oAX);_(ouW,ovW);var oFX = _n("view");_r(oFX, 'class', 11, e, s, gg);var oGX = _n("view");_r(oGX, 'class', 12, e, s, gg);var oHX = _o(13, e, s, gg);_(oGX,oHX);_(oFX,oGX);var oIX = _n("view");_r(oIX, 'class', 14, e, s, gg);var oJX = _o(15, e, s, gg);_(oIX,oJX);_(oFX,oIX);_(ouW,oFX);var oKX = _n("view");_r(oKX, 'class', 16, e, s, gg);var oLX = _n("view");_r(oLX, 'class', 17, e, s, gg);var oMX = _m( "image", ["class", 18,"src", 1], e, s, gg);_(oLX,oMX);var oNX = _o(20, e, s, gg);_(oLX,oNX);_(oKX,oLX);var oOX = _n("view");_r(oOX, 'class', 21, e, s, gg);var oPX = _n("view");_r(oPX, 'class', 22, e, s, gg);var oQX = _n("view");_r(oQX, 'class', 23, e, s, gg);var oRX = _o(24, e, s, gg);_(oQX,oRX);_(oPX,oQX);var oSX = _n("view");_r(oSX, 'class', 23, e, s, gg);var oTX = _o(25, e, s, gg);_(oSX,oTX);_(oPX,oSX);var oUX = _n("view");_r(oUX, 'class', 23, e, s, gg);var oVX = _o(26, e, s, gg);_(oUX,oVX);_(oPX,oUX);_(oOX,oPX);var oWX = _v();var oXX = function(obX,oaX,oZX,gg){var oYX = _n("view");_r(oYX, 'class', 22, obX, oaX, gg);var odX = _v();
      if (_o(29, obX, oaX, gg)) {
        odX.wxVkey = 1;var oeX = _n("view");var ogX = _n("view");_r(ogX, 'class', 30, obX, oaX, gg);var ohX = _o(31, obX, oaX, gg);_(ogX,ohX);_(oeX,ogX);var oiX = _n("view");_r(oiX, 'class', 30, obX, oaX, gg);var ojX = _o(32, obX, oaX, gg);_(oiX,ojX);_(oeX,oiX);var okX = _n("view");_r(okX, 'class', 33, obX, oaX, gg);var olX = _o(34, obX, oaX, gg);_(okX,olX);_(oeX,okX);_(odX, oeX);
      } _(oYX,odX);var omX = _v();
      if (_o(35, obX, oaX, gg)) {
        omX.wxVkey = 1;var onX = _n("view");var opX = _n("view");_r(opX, 'class', 30, obX, oaX, gg);var oqX = _o(31, obX, oaX, gg);_(opX,oqX);_(onX,opX);var orX = _n("view");_r(orX, 'class', 30, obX, oaX, gg);var osX = _o(36, obX, oaX, gg);_(orX,osX);_(onX,orX);var otX = _n("view");_r(otX, 'class', 33, obX, oaX, gg);var ouX = _o(37, obX, oaX, gg);_(otX,ouX);_(onX,otX);_(omX, onX);
      } _(oYX,omX);_(oZX, oYX);return oZX;};_2(27, oXX, e, s, gg, oWX, "item", "index", '{{item.id}}');_(oOX,oWX);_(oKX,oOX);var ovX = _v();
      if (_o(38, e, s, gg)) {
        ovX.wxVkey = 1;var owX = _m( "view", ["bindtap", 39,"class", 1], e, s, gg);var oyX = _o(41, e, s, gg);_(owX,oyX);_(ovX, owX);
      }else {
        ovX.wxVkey = 2;var ozX = _n("view");_r(ozX, 'class', 40, e, s, gg);var oAY = _o(42, e, s, gg);_(ozX,oAY);_(ovX, ozX);
      }_(oKX,ovX);var oBY = _n("view");_r(oBY, 'class', 43, e, s, gg);_(oKX,oBY);_(ouW,oKX);_(r,ouW);
    return r;
  };
