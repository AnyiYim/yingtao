...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var obW = _n("view");_r(obW, 'class', 0, e, s, gg);var ocW = _n("view");_r(ocW, 'class', 1, e, s, gg);var odW = _m( "scroll-view", ["class", 2,"scrollLeft", 1,"scrollX", 2,"style", 3], e, s, gg);var oeW = _n("view");_r(oeW, 'class', 6, e, s, gg);var ofW = _n("view");_r(ofW, 'class', 7, e, s, gg);var ogW = _m( "view", ["bindtap", 8,"class", 1], e, s, gg);var ohW = _o(10, e, s, gg);_(ogW,ohW);_(ofW,ogW);_(oeW,ofW);var oiW = _n("view");_r(oiW, 'class', 11, e, s, gg);var ojW = _m( "view", ["bindtap", 12,"class", 1], e, s, gg);var okW = _o(14, e, s, gg);_(ojW,okW);_(oiW,ojW);_(oeW,oiW);_(odW,oeW);_(ocW,odW);_(obW,ocW);var olW = _n("view");_r(olW, 'class', 15, e, s, gg);var omW = _v();var onW = function(orW,oqW,opW,gg){var ooW = _m( "view", ["bindtap", 18,"bindtouchend", 1,"bindtouchstart", 2,"class", 3,"data-index", 4,"style", 5], orW, oqW, gg);var otW = _m( "image", ["class", 24,"src", 1], orW, oqW, gg);_(ooW,otW);var ouW = _n("view");_r(ouW, 'class', 26, orW, oqW, gg);var ovW = _n("view");_r(ovW, 'class', 27, orW, oqW, gg);var owW = _o(28, orW, oqW, gg);_(ovW,owW);_(ouW,ovW);var oxW = _n("view");_r(oxW, 'class', 29, orW, oqW, gg);_(ouW,oxW);var oyW = _n("view");_r(oyW, 'class', 30, orW, oqW, gg);var ozW = _n("view");_r(ozW, 'class', 31, orW, oqW, gg);var o_W = _o(32, orW, oqW, gg);_(ozW,o_W);_(oyW,ozW);_(ouW,oyW);_(ooW,ouW);_(opW, ooW);return opW;};_2(16, onW, e, s, gg, omW, "item", "index", '{{item.id}}');_(olW,omW);_(obW,olW);var oAX = _m( "view", ["class", 33,"style", 1], e, s, gg);var oBX = _v();
      if (_o(35, e, s, gg)) {
        oBX.wxVkey = 1;var oCX = _n("view");var oEX = _m( "image", ["class", 36,"src", 1], e, s, gg);_(oCX,oEX);var oFX = _n("view");_r(oFX, 'class', 38, e, s, gg);var oGX = _o(39, e, s, gg);_(oFX,oGX);_(oCX,oFX);_(oBX, oCX);
      }else {
        oBX.wxVkey = 2;var oHX = _n("view");var oJX = _m( "image", ["class", 36,"src", 1], e, s, gg);_(oHX,oJX);var oKX = _n("view");_r(oKX, 'class', 38, e, s, gg);var oLX = _o(40, e, s, gg);_(oKX,oLX);_(oHX,oKX);_(oBX, oHX);
      }_(oAX,oBX);_(obW,oAX);_(r,obW);
    return r;
  };
