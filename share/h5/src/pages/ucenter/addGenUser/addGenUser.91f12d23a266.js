...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oxR = _n("view");_r(oxR, 'class', 0, e, s, gg);var oyR = _v();
      if (_o(1, e, s, gg)) {
        oyR.wxVkey = 1;var ozR = _n("navigator");_r(ozR, 'url', 2, e, s, gg);var oAS = _n("view");_r(oAS, 'class', 3, e, s, gg);var oBS = _n("view");_r(oBS, 'class', 4, e, s, gg);var oCS = _n("view");_r(oCS, 'class', 5, e, s, gg);var oDS = _o(6, e, s, gg);_(oCS,oDS);_(oBS,oCS);_(oAS,oBS);var oES = _n("view");_r(oES, 'class', 7, e, s, gg);var oFS = _m( "image", ["class", 8,"src", 1], e, s, gg);_(oES,oFS);_(oAS,oES);_(ozR,oAS);_(oyR, ozR);
      } _(oxR,oyR);var oGS = _n("view");_r(oGS, 'bindtap', 10, e, s, gg);var oHS = _m( "image", ["class", 11,"src", 1], e, s, gg);_(oGS,oHS);_(oxR,oGS);var oIS = _n("view");_r(oIS, 'class', 13, e, s, gg);var oJS = _o(14, e, s, gg);_(oIS,oJS);_(oxR,oIS);var oKS = _n("view");_r(oKS, 'class', 15, e, s, gg);var oLS = _o(16, e, s, gg);_(oKS,oLS);_(oxR,oKS);var oMS = _n("view");_r(oMS, 'class', 17, e, s, gg);var oNS = _v();var oOS = function(oSS,oRS,oQS,gg){var oPS = _n("view");_r(oPS, 'class', 20, oSS, oRS, gg);var oUS = _n("view");_r(oUS, 'class', 21, oSS, oRS, gg);var oVS = _n("view");_r(oVS, 'class', 22, oSS, oRS, gg);var oWS = _m( "image", ["class", 11,"src", 12], oSS, oRS, gg);_(oVS,oWS);_(oUS,oVS);var oXS = _n("view");_r(oXS, 'class', 24, oSS, oRS, gg);var oYS = _n("view");_r(oYS, 'class', 25, oSS, oRS, gg);var oZS = _o(26, oSS, oRS, gg);_(oYS,oZS);_(oXS,oYS);var oaS = _n("view");_r(oaS, 'class', 27, oSS, oRS, gg);var obS = _o(28, oSS, oRS, gg);_(oaS,obS);_(oXS,oaS);_(oUS,oXS);_(oPS,oUS);var ocS = _n("view");_r(ocS, 'class', 29, oSS, oRS, gg);var odS = _n("view");_r(odS, 'class', 30, oSS, oRS, gg);var oeS = _o(31, oSS, oRS, gg);_(odS,oeS);_(ocS,odS);var ofS = _n("view");_r(ofS, 'class', 32, oSS, oRS, gg);var ogS = _o(33, oSS, oRS, gg);_(ofS,ogS);_(ocS,ofS);_(oPS,ocS);_(oQS, oPS);return oQS;};_2(18, oOS, e, s, gg, oNS, "item", "index", '{{item.mobile}}');_(oMS,oNS);_(oxR,oMS);_(r,oxR);
    return r;
  };
