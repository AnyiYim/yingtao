...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var ohU = _n("view");_r(ohU, 'class', 0, e, s, gg);var oiU = _n("view");_r(oiU, 'class', 1, e, s, gg);var ojU = _m( "scroll-view", ["class", 2,"scrollLeft", 1,"scrollX", 2,"style", 3], e, s, gg);var okU = _n("view");_r(okU, 'class', 6, e, s, gg);var olU = _n("view");_r(olU, 'class', 7, e, s, gg);var omU = _m( "view", ["bindtap", 8,"class", 1], e, s, gg);var onU = _o(10, e, s, gg);_(omU,onU);_(olU,omU);_(okU,olU);var ooU = _n("view");_r(ooU, 'class', 11, e, s, gg);var opU = _m( "view", ["bindtap", 12,"class", 1], e, s, gg);var oqU = _o(14, e, s, gg);_(opU,oqU);_(ooU,opU);_(okU,ooU);_(ojU,okU);_(oiU,ojU);_(ohU,oiU);var orU = _n("view");_r(orU, 'class', 15, e, s, gg);var osU = _v();var otU = function(oxU,owU,ovU,gg){var ouU = _m( "view", ["bindtap", 18,"bindtouchend", 1,"bindtouchstart", 2,"class", 3,"data-index", 4,"style", 5], oxU, owU, gg);var ozU = _m( "image", ["class", 24,"src", 1], oxU, owU, gg);_(ouU,ozU);var o_U = _n("view");_r(o_U, 'class', 26, oxU, owU, gg);var oAV = _n("view");_r(oAV, 'class', 27, oxU, owU, gg);var oBV = _o(28, oxU, owU, gg);_(oAV,oBV);_(o_U,oAV);var oCV = _n("view");_r(oCV, 'class', 29, oxU, owU, gg);_(o_U,oCV);var oDV = _n("view");_r(oDV, 'class', 30, oxU, owU, gg);var oEV = _n("view");_r(oEV, 'class', 31, oxU, owU, gg);var oFV = _o(32, oxU, owU, gg);_(oEV,oFV);_(oDV,oEV);_(o_U,oDV);_(ouU,o_U);_(ovU, ouU);return ovU;};_2(16, otU, e, s, gg, osU, "item", "index", '{{item.id}}');_(orU,osU);_(ohU,orU);var oGV = _m( "view", ["class", 33,"style", 1], e, s, gg);var oHV = _v();
      if (_o(35, e, s, gg)) {
        oHV.wxVkey = 1;var oIV = _n("view");var oKV = _m( "image", ["class", 36,"src", 1], e, s, gg);_(oIV,oKV);var oLV = _n("view");_r(oLV, 'class', 38, e, s, gg);var oMV = _o(39, e, s, gg);_(oLV,oMV);_(oIV,oLV);_(oHV, oIV);
      }else {
        oHV.wxVkey = 2;var oNV = _n("view");var oPV = _m( "image", ["class", 36,"src", 1], e, s, gg);_(oNV,oPV);var oQV = _n("view");_r(oQV, 'class', 38, e, s, gg);var oRV = _o(40, e, s, gg);_(oQV,oRV);_(oNV,oQV);_(oHV, oNV);
      }_(oGV,oHV);_(ohU,oGV);_(r,ohU);
    return r;
  };
