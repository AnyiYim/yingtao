var uri = location.origin + '/api_bonus/bonus';
var url = {
    '销售订单':             uri+'/bill',
...
var get_data = function(){
    ...
    //     }
    //
    //     var download_a_path = '../api_file/excel/download_days_excel?';
    ...
    $('.date-xls-bt02').on('click', function() {
        ...
        var download_a_path = '../api_file/excel/download_excel?';
        ...
        console.log(time_name, ctime);

        download_a_path = download_a_path + time_name+"="+ctime
        console.log(download_a_path);
...
var upload = function(){
 ...
 $('.init-btn').on('click', function(){
     $.post('/api_bonus/bonus/daily_record', '', function(raw){
     });
 })
