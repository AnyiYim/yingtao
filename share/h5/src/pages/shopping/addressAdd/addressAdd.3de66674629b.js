...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oNM = _n("view");_r(oNM, 'class', 0, e, s, gg);var oOM = _n("view");_r(oOM, 'class', 1, e, s, gg);var oPM = _n("view");_r(oPM, 'class', 2, e, s, gg);var oQM = _m( "input", ["bindinput", 3,"class", 1,"placeholder", 2,"value", 3], e, s, gg);_(oPM,oQM);_(oOM,oPM);var oRM = _n("view");_r(oRM, 'class', 2, e, s, gg);var oSM = _m( "input", ["class", 4,"bindinput", 3,"placeholder", 4,"value", 5], e, s, gg);_(oRM,oSM);_(oOM,oRM);var oTM = _n("view");_r(oTM, 'class', 2, e, s, gg);var oUM = _m( "input", ["class", 4,"bindtap", 6,"disabled", 7,"placeholder", 8,"value", 9], e, s, gg);_(oTM,oUM);_(oOM,oTM);var oVM = _n("view");_r(oVM, 'class', 2, e, s, gg);var oWM = _m( "input", ["class", 4,"bindblur", 10,"bindfocus", 11,"bindinput", 12,"placeholder", 13,"value", 14], e, s, gg);_(oVM,oWM);_(oOM,oVM);var oXM = _n("view");_r(oXM, 'class', 19, e, s, gg);var oYM = _m( "text", ["bindtap", 20,"class", 1], e, s, gg);var oZM = _o(22, e, s, gg);_(oYM,oZM);_(oXM,oYM);_(oOM,oXM);_(oNM,oOM);var oaM = _n("view");_r(oaM, 'class', 23, e, s, gg);var obM = _m( "button", ["bindtap", 24,"class", 1], e, s, gg);var ocM = _o(26, e, s, gg);_(obM,ocM);_(oaM,obM);var odM = _m( "button", ["bindtap", 27,"class", 1], e, s, gg);var oeM = _o(29, e, s, gg);_(odM,oeM);_(oaM,odM);_(oNM,oaM);var ofM = _v();
      if (_o(30, e, s, gg)) {
        ofM.wxVkey = 1;var ogM = _n("view");_r(ogM, 'class', 31, e, s, gg);var oiM = _n("view");_r(oiM, 'class', 32, e, s, gg);var ojM = _n("view");_r(ojM, 'class', 33, e, s, gg);var okM = _v();var olM = function(opM,ooM,onM,gg){var omM = _m( "view", ["bindtap", 36,"class", 1,"data-region-type-index", 2], opM, ooM, gg);var orM = _o(39, opM, ooM, gg);_(omM,orM);_(onM, omM);return onM;};_2(34, olM, e, s, gg, okM, "item", "index", '{{item.id}}');_(ojM,okM);_(oiM,ojM);var osM = _m( "view", ["bindtap", 40,"class", 1], e, s, gg);var otM = _o(42, e, s, gg);_(osM,otM);_(oiM,osM);_(ogM,oiM);var ouM = _n("view");_r(ouM, 'class', 43, e, s, gg);var ovM = _n("view");_r(ovM, 'class', 44, e, s, gg);var owM = _v();var oxM = function(oAN,o_M,ozM,gg){var oyM = _m( "view", ["data-region-index", 38,"bindtap", 8,"class", 9], oAN, o_M, gg);var oCN = _o(39, oAN, o_M, gg);_(oyM,oCN);_(ozM, oyM);return ozM;};_2(45, oxM, e, s, gg, owM, "item", "index", '{{item.id}}');_(ovM,owM);_(ouM,ovM);_(ogM,ouM);_(ofM, ogM);
      } _(oNM,ofM);_(r,oNM);var oDN = _v();
      if (_o(30, e, s, gg)) {
        oDN.wxVkey = 1;var oEN = _m( "view", ["bindtap", 48,"class", 1], e, s, gg);_(oDN, oEN);
      } _(r,oDN);
    return r;
  };
