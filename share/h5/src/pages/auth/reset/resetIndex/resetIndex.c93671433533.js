...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oFE = _n("view");_r(oFE, 'class', 0, e, s, gg);var oGE = _n("view");_r(oGE, 'class', 1, e, s, gg);_(oFE,oGE);var oHE = _n("view");_r(oHE, 'class', 2, e, s, gg);var oIE = _n("view");_r(oIE, 'class', 3, e, s, gg);var oJE = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oIE,oJE);_(oHE,oIE);var oKE = _n("view");_r(oKE, 'class', 6, e, s, gg);var oLE = _n("view");_r(oLE, 'class', 7, e, s, gg);var oME = _o(8, e, s, gg);_(oLE,oME);_(oKE,oLE);_(oHE,oKE);_(oFE,oHE);var oNE = _n("view");_r(oNE, 'class', 9, e, s, gg);var oOE = _n("view");_r(oOE, 'class', 10, e, s, gg);var oPE = _m( "input", ["bindinput", 11,"class", 1,"placeholder", 2], e, s, gg);_(oOE,oPE);var oQE = _v();
      if (_o(14, e, s, gg)) {
        oQE.wxVkey = 1;var oRE = _m( "image", ["catchtap", 15,"class", 1,"id", 2,"src", 3], e, s, gg);_(oQE, oRE);
      } _(oOE,oQE);_(oNE,oOE);var oTE = _n("view");_r(oTE, 'class', 19, e, s, gg);var oUE = _n("view");_r(oUE, 'class', 20, e, s, gg);var oVE = _m( "input", ["bindinput", 21,"class", 1,"placeholder", 2,"value", 3], e, s, gg);_(oUE,oVE);var oWE = _v();
      if (_o(25, e, s, gg)) {
        oWE.wxVkey = 1;var oXE = _m( "image", ["catchtap", 15,"class", 1,"src", 3,"id", 11], e, s, gg);_(oWE, oXE);
      } _(oUE,oWE);_(oTE,oUE);var oZE = _m( "button", ["bindtap", 27,"class", 1,"disabled", 2,"size", 3,"type", 4], e, s, gg);var oaE = _o(32, e, s, gg);_(oZE,oaE);_(oTE,oZE);_(oNE,oTE);var obE = _m( "button", ["bindtap", 33,"class", 1,"type", 2], e, s, gg);var ocE = _o(36, e, s, gg);_(obE,ocE);_(oNE,obE);_(oFE,oNE);_(r,oFE);
    return r;
  };
