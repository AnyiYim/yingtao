...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var opS = _n("view");_r(opS, 'class', 0, e, s, gg);var oqS = _n("view");_r(oqS, 'class', 1, e, s, gg);_(opS,oqS);var orS = _m( "view", ["bindtap", 2,"class", 1], e, s, gg);var osS = _n("view");_r(osS, 'class', 4, e, s, gg);var otS = _o(5, e, s, gg);_(osS,otS);_(orS,osS);var ouS = _n("view");_r(ouS, 'class', 6, e, s, gg);var ovS = _n("view");_r(ovS, 'class', 7, e, s, gg);var owS = _m( "image", ["class", 8,"src", 1], e, s, gg);_(ovS,owS);_(ouS,ovS);var oxS = _n("view");_r(oxS, 'class', 7, e, s, gg);var oyS = _m( "image", ["class", 10,"src", 1], e, s, gg);_(oxS,oyS);_(ouS,oxS);_(orS,ouS);_(opS,orS);var ozS = _n("view");_r(ozS, 'class', 1, e, s, gg);_(opS,ozS);var o_S = _n("view");_r(o_S, 'class', 12, e, s, gg);var oAT = _m( "navigator", ["class", 13,"url", 1], e, s, gg);var oBT = _m( "view", ["bindtap", 15,"class", 1], e, s, gg);var oCT = _n("view");_r(oCT, 'class', 17, e, s, gg);var oDT = _o(18, e, s, gg);_(oCT,oDT);_(oBT,oCT);var oET = _n("view");_r(oET, 'class', 19, e, s, gg);var oFT = _v();
      if (_o(20, e, s, gg)) {
        oFT.wxVkey = 1;var oGT = _n("view");_r(oGT, 'class', 21, e, s, gg);var oIT = _o(22, e, s, gg);_(oGT,oIT);_(oFT, oGT);
      }else {
        oFT.wxVkey = 2;var oJT = _n("view");_r(oJT, 'class', 21, e, s, gg);var oLT = _o(23, e, s, gg);_(oJT,oLT);_(oFT, oJT);
      }_(oET,oFT);var oMT = _n("view");_r(oMT, 'class', 24, e, s, gg);var oNT = _m( "image", ["class", 10,"src", 1], e, s, gg);_(oMT,oNT);_(oET,oMT);_(oBT,oET);_(oAT,oBT);_(o_S,oAT);var oOT = _m( "navigator", ["class", 13,"url", 12], e, s, gg);var oPT = _n("view");_r(oPT, 'class', 16, e, s, gg);var oQT = _n("view");_r(oQT, 'class', 17, e, s, gg);var oRT = _o(26, e, s, gg);_(oQT,oRT);_(oPT,oQT);var oST = _n("view");_r(oST, 'class', 19, e, s, gg);var oTT = _n("view");_r(oTT, 'class', 21, e, s, gg);var oUT = _o(27, e, s, gg);_(oTT,oUT);_(oST,oTT);var oVT = _n("view");_r(oVT, 'class', 24, e, s, gg);var oWT = _m( "image", ["class", 10,"src", 1], e, s, gg);_(oVT,oWT);_(oST,oVT);_(oPT,oST);_(oOT,oPT);_(o_S,oOT);var oXT = _n("view");_r(oXT, 'class', 1, e, s, gg);_(o_S,oXT);var oYT = _n("view");_r(oYT, 'class', 28, e, s, gg);var oZT = _n("view");_r(oZT, 'class', 29, e, s, gg);var oaT = _m( "view", ["bindtap", 30,"class", 1], e, s, gg);var obT = _m( "image", ["class", 32,"src", 1], e, s, gg);_(oaT,obT);_(oZT,oaT);_(oYT,oZT);var ocT = _n("view");_r(ocT, 'class', 34, e, s, gg);var odT = _m( "view", ["bindtap", 35,"class", 1], e, s, gg);var oeT = _o(37, e, s, gg);_(odT,oeT);_(ocT,odT);_(oYT,ocT);_(o_S,oYT);_(opS,o_S);_(r,opS);
    return r;
  };
