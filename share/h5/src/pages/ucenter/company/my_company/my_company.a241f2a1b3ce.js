...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oTV = _n("view");_r(oTV, 'class', 0, e, s, gg);var oUV = _n("view");_r(oUV, 'class', 1, e, s, gg);var oVV = _m( "view", ["class", 2,"style", 1], e, s, gg);var oWV = _n("view");_r(oWV, 'class', 4, e, s, gg);var oXV = _o(5, e, s, gg);_(oWV,oXV);_(oVV,oWV);var oYV = _n("view");_r(oYV, 'class', 6, e, s, gg);var oZV = _o(7, e, s, gg);_(oYV,oZV);_(oVV,oYV);_(oUV,oVV);var oaV = _m( "view", ["class", 2,"style", 6], e, s, gg);var obV = _n("view");_r(obV, 'class', 4, e, s, gg);var ocV = _o(9, e, s, gg);_(obV,ocV);_(oaV,obV);var odV = _n("view");_r(odV, 'class', 6, e, s, gg);var oeV = _o(10, e, s, gg);_(odV,oeV);_(oaV,odV);_(oUV,oaV);_(oTV,oUV);var ofV = _n("view");_r(ofV, 'class', 11, e, s, gg);var ogV = _n("view");_r(ogV, 'class', 12, e, s, gg);var ohV = _o(13, e, s, gg);_(ogV,ohV);_(ofV,ogV);var oiV = _n("view");_r(oiV, 'class', 14, e, s, gg);var ojV = _o(15, e, s, gg);_(oiV,ojV);_(ofV,oiV);_(oTV,ofV);var okV = _n("view");_r(okV, 'class', 16, e, s, gg);var olV = _n("view");_r(olV, 'class', 17, e, s, gg);var omV = _m( "image", ["class", 18,"src", 1], e, s, gg);_(olV,omV);var onV = _o(20, e, s, gg);_(olV,onV);_(okV,olV);var ooV = _n("view");_r(ooV, 'class', 21, e, s, gg);var opV = _n("view");_r(opV, 'class', 22, e, s, gg);var oqV = _n("view");_r(oqV, 'class', 23, e, s, gg);var orV = _o(24, e, s, gg);_(oqV,orV);_(opV,oqV);var osV = _n("view");_r(osV, 'class', 23, e, s, gg);var otV = _o(25, e, s, gg);_(osV,otV);_(opV,osV);var ouV = _n("view");_r(ouV, 'class', 23, e, s, gg);var ovV = _o(26, e, s, gg);_(ouV,ovV);_(opV,ouV);_(ooV,opV);var owV = _v();var oxV = function(oAW,o_V,ozV,gg){var oyV = _n("view");_r(oyV, 'class', 22, oAW, o_V, gg);var oCW = _v();
      if (_o(29, oAW, o_V, gg)) {
        oCW.wxVkey = 1;var oDW = _n("view");var oFW = _n("view");_r(oFW, 'class', 30, oAW, o_V, gg);var oGW = _o(31, oAW, o_V, gg);_(oFW,oGW);_(oDW,oFW);var oHW = _n("view");_r(oHW, 'class', 30, oAW, o_V, gg);var oIW = _o(32, oAW, o_V, gg);_(oHW,oIW);_(oDW,oHW);var oJW = _n("view");_r(oJW, 'class', 33, oAW, o_V, gg);var oKW = _o(34, oAW, o_V, gg);_(oJW,oKW);_(oDW,oJW);_(oCW, oDW);
      } _(oyV,oCW);var oLW = _v();
      if (_o(35, oAW, o_V, gg)) {
        oLW.wxVkey = 1;var oMW = _n("view");var oOW = _n("view");_r(oOW, 'class', 30, oAW, o_V, gg);var oPW = _o(31, oAW, o_V, gg);_(oOW,oPW);_(oMW,oOW);var oQW = _n("view");_r(oQW, 'class', 30, oAW, o_V, gg);var oRW = _o(36, oAW, o_V, gg);_(oQW,oRW);_(oMW,oQW);var oSW = _n("view");_r(oSW, 'class', 33, oAW, o_V, gg);var oTW = _o(37, oAW, o_V, gg);_(oSW,oTW);_(oMW,oSW);_(oLW, oMW);
      } _(oyV,oLW);_(ozV, oyV);return ozV;};_2(27, oxV, e, s, gg, owV, "item", "index", '{{item.id}}');_(ooV,owV);_(okV,ooV);var oUW = _v();
      if (_o(38, e, s, gg)) {
        oUW.wxVkey = 1;var oVW = _m( "view", ["bindtap", 39,"class", 1], e, s, gg);var oXW = _o(41, e, s, gg);_(oVW,oXW);_(oUW, oVW);
      }else {
        oUW.wxVkey = 2;var oYW = _n("view");_r(oYW, 'class', 40, e, s, gg);var oaW = _o(42, e, s, gg);_(oYW,oaW);_(oUW, oYW);
      }_(okV,oUW);var obW = _n("view");_r(obW, 'class', 43, e, s, gg);_(okV,obW);_(oTV,okV);_(r,oTV);
    return r;
  };
