...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oUP = _n("view");_r(oUP, 'class', 0, e, s, gg);var oVP = _v();
      if (_o(1, e, s, gg)) {
        oVP.wxVkey = 1;var oYP = _m( "view", ["bindtap", 2,"class", 1], e, s, gg);var oZP = _m( "image", ["class", 4,"src", 1], e, s, gg);_(oYP,oZP);var oaP = _n("view");_r(oaP, 'class', 6, e, s, gg);var obP = _n("text");_r(obP, 'class', 7, e, s, gg);var ocP = _o(8, e, s, gg);_(obP,ocP);_(oaP,obP);var odP = _n("text");_r(odP, 'class', 9, e, s, gg);var oeP = _o(10, e, s, gg);_(odP,oeP);_(oaP,odP);_(oYP,oaP);_(oVP,oYP);
      } _(oUP,oVP);var ofP = _v();
      if (_o(11, e, s, gg)) {
        ofP.wxVkey = 1;var oiP = _m( "view", ["class", 3,"bindtap", 9], e, s, gg);var ojP = _m( "open-data", ["class", 4,"type", 9], e, s, gg);_(oiP,ojP);var okP = _n("view");_r(okP, 'class', 6, e, s, gg);var olP = _m( "open-data", ["class", 7,"type", 7], e, s, gg);_(okP,olP);var omP = _n("text");_r(omP, 'class', 9, e, s, gg);var onP = _o(15, e, s, gg);_(omP,onP);_(okP,omP);_(oiP,okP);_(ofP,oiP);
      } _(oUP,ofP);var ooP = _n("view");_r(ooP, 'class', 16, e, s, gg);var opP = _n("view");_r(opP, 'class', 17, e, s, gg);var oqP = _n("view");_r(oqP, 'class', 18, e, s, gg);var orP = _m( "view", ["bindtap", 19,"class", 1,"data-module", 2], e, s, gg);var osP = _n("view");_r(osP, 'class', 22, e, s, gg);_(orP,osP);var otP = _n("view");_r(otP, 'class', 23, e, s, gg);var ouP = _o(24, e, s, gg);_(otP,ouP);_(orP,otP);_(oqP,orP);_(opP,oqP);var ovP = _n("view");_r(ovP, 'class', 18, e, s, gg);var owP = _m( "view", ["bindtap", 19,"class", 1,"data-module", 6], e, s, gg);var oxP = _n("text");_r(oxP, 'class', 26, e, s, gg);_(owP,oxP);var oyP = _n("text");_r(oyP, 'class', 23, e, s, gg);var ozP = _o(27, e, s, gg);_(oyP,ozP);_(owP,oyP);_(ovP,owP);_(opP,ovP);var o_P = _n("view");_r(o_P, 'class', 18, e, s, gg);var oAQ = _m( "view", ["bindtap", 19,"class", 1,"data-module", 9], e, s, gg);var oBQ = _n("text");_r(oBQ, 'class', 29, e, s, gg);_(oAQ,oBQ);var oCQ = _n("text");_r(oCQ, 'class', 23, e, s, gg);var oDQ = _o(30, e, s, gg);_(oCQ,oDQ);_(oAQ,oCQ);_(o_P,oAQ);_(opP,o_P);_(ooP,opP);var oEQ = _n("view");_r(oEQ, 'class', 17, e, s, gg);var oFQ = _n("view");_r(oFQ, 'class', 18, e, s, gg);var oGQ = _v();
      if (_o(31, e, s, gg)) {
        oGQ.wxVkey = 1;var oHQ = _n("view");_r(oHQ, 'class', 32, e, s, gg);_(oGQ, oHQ);
      } _(oFQ,oGQ);var oJQ = _m( "view", ["bindtap", 19,"class", 1,"data-module", 14], e, s, gg);var oKQ = _n("text");_r(oKQ, 'class', 34, e, s, gg);_(oJQ,oKQ);var oLQ = _n("text");_r(oLQ, 'class', 23, e, s, gg);var oMQ = _o(35, e, s, gg);_(oLQ,oMQ);_(oJQ,oLQ);_(oFQ,oJQ);_(oEQ,oFQ);var oNQ = _n("view");_r(oNQ, 'class', 18, e, s, gg);var oOQ = _m( "view", ["bindtap", 19,"class", 1,"data-module", 17], e, s, gg);var oPQ = _n("text");_r(oPQ, 'class', 37, e, s, gg);_(oOQ,oPQ);var oQQ = _n("text");_r(oQQ, 'class', 23, e, s, gg);var oRQ = _o(38, e, s, gg);_(oQQ,oRQ);_(oOQ,oQQ);_(oNQ,oOQ);_(oEQ,oNQ);var oSQ = _n("view");_r(oSQ, 'class', 18, e, s, gg);var oTQ = _m( "view", ["bindtap", 19,"class", 1,"data-module", 20], e, s, gg);var oUQ = _n("text");_r(oUQ, 'class', 40, e, s, gg);_(oTQ,oUQ);var oVQ = _n("text");_r(oVQ, 'class', 23, e, s, gg);var oWQ = _o(41, e, s, gg);_(oVQ,oWQ);_(oTQ,oVQ);_(oSQ,oTQ);_(oEQ,oSQ);_(ooP,oEQ);var oXQ = _n("view");_r(oXQ, 'class', 17, e, s, gg);var oYQ = _n("view");_r(oYQ, 'class', 18, e, s, gg);var oZQ = _m( "view", ["bindtap", 19,"class", 1,"data-module", 23], e, s, gg);var oaQ = _n("text");_r(oaQ, 'class', 43, e, s, gg);_(oZQ,oaQ);var obQ = _n("text");_r(obQ, 'class', 23, e, s, gg);var ocQ = _o(44, e, s, gg);_(obQ,ocQ);_(oZQ,obQ);_(oYQ,oZQ);_(oXQ,oYQ);var odQ = _n("view");_r(odQ, 'class', 18, e, s, gg);var oeQ = _m( "view", ["bindtap", 19,"class", 1,"data-module", 26], e, s, gg);var ofQ = _n("text");_r(ofQ, 'class', 46, e, s, gg);_(oeQ,ofQ);var ogQ = _n("text");_r(ogQ, 'class', 23, e, s, gg);var ohQ = _o(47, e, s, gg);_(ogQ,ohQ);_(oeQ,ogQ);_(odQ,oeQ);_(oXQ,odQ);_(ooP,oXQ);_(oUP,ooP);_(r,oUP);
    return r;
  };
...
var jumplist = {
    ...
    'userIdentification': '/pages/ucenter/userIdentification/userIdentification',
}
