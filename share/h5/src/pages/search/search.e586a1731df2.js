...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var owK = _n("view");_r(owK, 'class', 0, e, s, gg);var oxK = _n("view");_r(oxK, 'class', 1, e, s, gg);var oyK = _n("view");_r(oyK, 'class', 2, e, s, gg);var ozK = _m( "image", ["class", 3,"src", 1], e, s, gg);_(oyK,ozK);var o_K = _m( "input", ["bindconfirm", 5,"bindfocus", 1,"bindinput", 2,"class", 3,"confirmType", 4,"confirmType", 4,"name", 5,"placeholder", 6,"value", 7], e, s, gg);_(oyK,o_K);var oAL = _v();
      if (_o(12, e, s, gg)) {
        oAL.wxVkey = 1;var oBL = _m( "image", ["bindtap", 13,"class", 1,"src", 2], e, s, gg);_(oAL, oBL);
      } _(oyK,oAL);_(oxK,oyK);var oDL = _m( "view", ["bindtap", 16,"class", 1], e, s, gg);var oEL = _o(18, e, s, gg);_(oDL,oEL);_(oxK,oDL);_(owK,oxK);var oFL = _n("scroll-view");var oGL = _v();
      if (_o(19, e, s, gg)) {
        oGL.wxVkey = 1;var oHL = _n("view");_r(oHL, 'class', 20, e, s, gg);var oJL = _n("view");_r(oJL, 'class', 21, e, s, gg);var oKL = _n("view");_r(oKL, 'class', 22, e, s, gg);var oLL = _v();var oML = function(oQL,oPL,oOL,gg){var oNL = _m( "navigator", ["class", 26,"url", 1], oQL, oPL, gg);var oSL = _m( "image", ["backgroundSize", 28,"class", 1,"src", 2], oQL, oPL, gg);_(oNL,oSL);var oTL = _n("text");_r(oTL, 'class', 31, oQL, oPL, gg);var oUL = _o(32, oQL, oPL, gg);_(oTL,oUL);_(oNL,oTL);var oVL = _n("text");_r(oVL, 'class', 33, oQL, oPL, gg);var oWL = _o(34, oQL, oPL, gg);_(oVL,oWL);_(oNL,oVL);_(oOL, oNL);return oOL;};_2(23, oML, e, s, gg, oLL, "iitem", "iindex", '');_(oKL,oLL);_(oJL,oKL);_(oHL,oJL);_(oGL, oHL);
      } _(oFL,oGL);var oXL = _v();
      if (_o(35, e, s, gg)) {
        oXL.wxVkey = 1;var oYL = _n("view");_r(oYL, 'class', 36, e, s, gg);var oaL = _n("view");_r(oaL, 'class', 37, e, s, gg);var obL = _o(38, e, s, gg);_(oaL,obL);_(oYL,oaL);_(oXL, oYL);
      } _(oFL,oXL);var ocL = _v();
      if (_o(39, e, s, gg)) {
        ocL.wxVkey = 1;var odL = _n("view");_r(odL, 'class', 40, e, s, gg);var ofL = _m( "image", ["class", 3,"src", 38], e, s, gg);_(odL,ofL);var ogL = _n("text");_r(ogL, 'class', 42, e, s, gg);var ohL = _o(43, e, s, gg);_(ogL,ohL);_(odL,ogL);_(ocL, odL);
      } _(oFL,ocL);_(owK,oFL);_(r,owK);
    return r;
  };
