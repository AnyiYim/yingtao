...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oBM = _n("view");_r(oBM, 'class', 0, e, s, gg);var oCM = _n("view");_r(oCM, 'class', 1, e, s, gg);var oDM = _v();
      if (_o(2, e, s, gg)) {
        oDM.wxVkey = 1;var oEM = _m( "view", ["bindtap", 3,"class", 1], e, s, gg);var oGM = _n("view");_r(oGM, 'class', 5, e, s, gg);var oHM = _n("text");_r(oHM, 'class', 6, e, s, gg);var oIM = _o(7, e, s, gg);_(oHM,oIM);_(oGM,oHM);var oJM = _v();
      if (_o(8, e, s, gg)) {
        oJM.wxVkey = 1;var oKM = _n("text");_r(oKM, 'class', 9, e, s, gg);var oMM = _o(10, e, s, gg);_(oKM,oMM);_(oJM, oKM);
      } _(oGM,oJM);_(oEM,oGM);var oNM = _n("view");_r(oNM, 'class', 11, e, s, gg);var oOM = _n("text");_r(oOM, 'class', 12, e, s, gg);var oPM = _o(13, e, s, gg);_(oOM,oPM);_(oNM,oOM);var oQM = _n("text");_r(oQM, 'class', 14, e, s, gg);var oRM = _o(15, e, s, gg);_(oQM,oRM);_(oNM,oQM);_(oEM,oNM);var oSM = _n("view");_r(oSM, 'class', 16, e, s, gg);var oTM = _n("image");_r(oTM, 'src', 17, e, s, gg);_(oSM,oTM);_(oEM,oSM);_(oDM, oEM);
      } _(oCM,oDM);var oUM = _v();
      if (_o(18, e, s, gg)) {
        oUM.wxVkey = 1;var oVM = _m( "view", ["bindtap", 19,"class", 1], e, s, gg);var oXM = _n("view");_r(oXM, 'class', 11, e, s, gg);var oYM = _o(21, e, s, gg);_(oXM,oYM);_(oVM,oXM);var oZM = _n("view");_r(oZM, 'class', 16, e, s, gg);var oaM = _n("image");_r(oaM, 'src', 17, e, s, gg);_(oZM,oaM);_(oVM,oZM);_(oUM, oVM);
      } _(oCM,oUM);_(oBM,oCM);var obM = _n("view");_r(obM, 'class', 22, e, s, gg);_(oBM,obM);var ocM = _n("view");_r(ocM, 'class', 23, e, s, gg);var odM = _n("view");_r(odM, 'class', 24, e, s, gg);var oeM = _n("view");_r(oeM, 'class', 5, e, s, gg);var ofM = _n("text");_r(ofM, 'class', 6, e, s, gg);var ogM = _o(25, e, s, gg);_(ofM,ogM);_(oeM,ofM);_(odM,oeM);var ohM = _n("view");_r(ohM, 'class', 16, e, s, gg);var oiM = _n("text");_r(oiM, 'class', 26, e, s, gg);var ojM = _o(27, e, s, gg);_(oiM,ojM);_(ohM,oiM);_(odM,ohM);_(ocM,odM);var okM = _n("view");_r(okM, 'class', 24, e, s, gg);var olM = _n("view");_r(olM, 'class', 5, e, s, gg);var omM = _n("text");_r(omM, 'class', 6, e, s, gg);var onM = _o(28, e, s, gg);_(omM,onM);_(olM,omM);_(okM,olM);var ooM = _n("view");_r(ooM, 'class', 16, e, s, gg);var opM = _n("text");_r(opM, 'class', 26, e, s, gg);var oqM = _o(29, e, s, gg);_(opM,oqM);_(ooM,opM);_(okM,ooM);_(ocM,okM);_(oBM,ocM);var orM = _n("view");_r(orM, 'class', 30, e, s, gg);var osM = _v();var otM = function(oxM,owM,ovM,gg){var ouM = _n("view");_r(ouM, 'class', 33, oxM, owM, gg);var ozM = _n("view");_r(ozM, 'class', 34, oxM, owM, gg);var o_M = _n("image");_r(o_M, 'src', 35, oxM, owM, gg);_(ozM,o_M);_(ouM,ozM);var oAN = _n("view");_r(oAN, 'class', 36, oxM, owM, gg);var oBN = _n("view");_r(oBN, 'class', 37, oxM, owM, gg);var oCN = _n("text");_r(oCN, 'class', 6, oxM, owM, gg);var oDN = _o(38, oxM, owM, gg);_(oCN,oDN);_(oBN,oCN);var oEN = _n("text");_r(oEN, 'class', 39, oxM, owM, gg);var oFN = _o(40, oxM, owM, gg);_(oEN,oFN);_(oBN,oEN);_(oAN,oBN);var oGN = _n("view");_r(oGN, 'class', 11, oxM, owM, gg);var oHN = _o(41, oxM, owM, gg);_(oGN,oHN);_(oAN,oGN);var oIN = _n("view");_r(oIN, 'class', 42, oxM, owM, gg);var oJN = _o(43, oxM, owM, gg);_(oIN,oJN);_(oAN,oIN);_(ouM,oAN);_(ovM, ouM);return ovM;};_2(31, otM, e, s, gg, osM, "item", "index", '{{item.id}}');_(orM,osM);_(oBM,orM);var oKN = _n("view");_r(oKN, 'class', 44, e, s, gg);var oLN = _n("view");_r(oLN, 'class', 5, e, s, gg);var oMN = _o(45, e, s, gg);_(oLN,oMN);_(oKN,oLN);var oNN = _m( "view", ["class", 16,"bindtap", 30], e, s, gg);var oON = _o(47, e, s, gg);_(oNN,oON);_(oKN,oNN);_(oBM,oKN);_(r,oBM);var oPN = _v();
      if (_o(48, e, s, gg)) {
        oPN.wxVkey = 1;var oQN = _n("web-view");_r(oQN, 'src', 48, e, s, gg);_(oPN, oQN);
      } _(r,oPN);
    return r;
  };
