...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oRF = _n("view");_r(oRF, 'class', 0, e, s, gg);var oSF = _n("view");_r(oSF, 'class', 1, e, s, gg);var oTF = _m( "view", ["bindtap", 2,"class", 1], e, s, gg);var oUF = _n("view");_r(oUF, 'class', 4, e, s, gg);var oVF = _o(5, e, s, gg);_(oUF,oVF);_(oTF,oUF);_(oSF,oTF);var oWF = _m( "view", ["bindtap", 2,"class", 4], e, s, gg);var oXF = _n("view");_r(oXF, 'class', 4, e, s, gg);var oYF = _o(7, e, s, gg);_(oXF,oYF);_(oWF,oXF);_(oSF,oWF);_(oRF,oSF);var oZF = _n("view");_r(oZF, 'class', 8, e, s, gg);var oaF = _v();var obF = function(ofF,oeF,odF,gg){var ocF = _n("view");_r(ocF, 'class', 11, ofF, oeF, gg);var ohF = _n("view");_r(ohF, 'class', 12, ofF, oeF, gg);var oiF = _n("view");_r(oiF, 'class', 13, ofF, oeF, gg);var ojF = _n("image");_r(ojF, 'src', 14, ofF, oeF, gg);_(oiF,ojF);var okF = _n("text");var olF = _o(15, ofF, oeF, gg);_(okF,olF);_(oiF,okF);_(ohF,oiF);var omF = _n("view");_r(omF, 'class', 16, ofF, oeF, gg);var onF = _o(17, ofF, oeF, gg);_(omF,onF);_(ohF,omF);_(ocF,ohF);var ooF = _n("view");_r(ooF, 'class', 18, ofF, oeF, gg);var opF = _o(19, ofF, oeF, gg);_(ooF,opF);_(ocF,ooF);var oqF = _v();
      if (_o(20, ofF, oeF, gg)) {
        oqF.wxVkey = 1;var orF = _n("view");_r(orF, 'class', 21, ofF, oeF, gg);var otF = _v();var ouF = function(oyF,oxF,owF,gg){var ovF = _m( "image", ["class", 25,"src", 1], oyF, oxF, gg);_(owF, ovF);return owF;};_2(22, ouF, ofF, oeF, gg, otF, "pitem", "index", '{{pitem.id}}');_(orF,otF);_(oqF, orF);
      } _(ocF,oqF);var o_F = _n("view");_r(o_F, 'class', 27, ofF, oeF, gg);_(ocF,o_F);_(odF, ocF);return odF;};_2(9, obF, e, s, gg, oaF, "item", "index", '{{item.id}}');_(oZF,oaF);_(oRF,oZF);_(r,oRF);
    return r;
  };
