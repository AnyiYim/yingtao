...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var odi = _n("view");_r(odi, 'class', 0, e, s, gg);var oei = _m( "image", ["class", 1,"src", 1,"style", 2], e, s, gg);_(odi,oei);var ofi = _n("view");_r(ofi, 'class', 4, e, s, gg);var ogi = _n("view");_r(ogi, 'class', 5, e, s, gg);var ohi = _m( "image", ["class", 6,"src", 1], e, s, gg);_(ogi,ohi);_(ofi,ogi);var oii = _n("view");_r(oii, 'class', 8, e, s, gg);var oji = _o(9, e, s, gg);_(oii,oji);_(ofi,oii);_(odi,ofi);var oki = _v();var oli = function(opi,ooi,oni,gg){var omi = _n("view");_r(omi, 'class', 12, opi, ooi, gg);var ori = _m( "navigator", ["class", 13,"url", 1], opi, ooi, gg);var osi = _m( "image", ["class", 15,"src", 1], opi, ooi, gg);_(ori,osi);var oti = _n("view");_r(oti, 'class', 17, opi, ooi, gg);var oui = _n("view");_r(oui, 'class', 18, opi, ooi, gg);var ovi = _n("view");_r(ovi, 'class', 19, opi, ooi, gg);var owi = _o(20, opi, ooi, gg);_(ovi,owi);_(oui,ovi);_(oti,oui);var oxi = _n("view");_r(oxi, 'class', 21, opi, ooi, gg);var oyi = _o(22, opi, ooi, gg);_(oxi,oyi);_(oti,oxi);_(ori,oti);_(omi,ori);_(oni, omi);return oni;};_2(10, oli, e, s, gg, oki, "item", "index", '{{item.id}}');_(odi,oki);var ozi = _n("view");_r(ozi, 'class', 23, e, s, gg);_(odi,ozi);var o_i = _n("view");var oAj = _n("navigator");_r(oAj, 'url', 24, e, s, gg);var oBj = _n("view");_r(oBj, 'class', 25, e, s, gg);var oCj = _o(26, e, s, gg);_(oBj,oCj);_(oAj,oBj);_(o_i,oAj);var oDj = _n("navigator");_r(oDj, 'url', 27, e, s, gg);var oEj = _n("view");_r(oEj, 'class', 28, e, s, gg);var oFj = _o(29, e, s, gg);_(oEj,oFj);_(oDj,oEj);_(o_i,oDj);_(odi,o_i);_(r,odi);
    return r;
  };
