...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var oDk = _n("view");_r(oDk, 'class', 0, e, s, gg);var oEk = _n("view");_r(oEk, 'class', 1, e, s, gg);var oFk = _m( "scroll-view", ["class", 2,"scrollLeft", 1,"scrollX", 2,"style", 3], e, s, gg);var oGk = _v();var oHk = function(oLk,oKk,oJk,gg){var oIk = _m( "view", ["class", 8,"data-index", 1], oLk, oKk, gg);var oNk = _n("view");_r(oNk, 'class', 10, oLk, oKk, gg);var oOk = _o(11, oLk, oKk, gg);_(oNk,oOk);_(oIk,oNk);_(oJk, oIk);return oJk;};_2(6, oHk, e, s, gg, oGk, "item", "index", '');_(oFk,oGk);_(oEk,oFk);_(oDk,oEk);var oPk = _n("view");_r(oPk, 'class', 12, e, s, gg);var oQk = _n("view");_r(oQk, 'class', 13, e, s, gg);_(oPk,oQk);var oRk = _n("view");_r(oRk, 'class', 14, e, s, gg);var oSk = _v();var oTk = function(oXk,oWk,oVk,gg){var oUk = _n("view");_r(oUk, 'class', 17, oXk, oWk, gg);var oZk = _n("view");_r(oZk, 'class', 18, oXk, oWk, gg);var oak = _n("view");_r(oak, 'class', 19, oXk, oWk, gg);var obk = _n("view");_r(obk, 'class', 20, oXk, oWk, gg);var ock = _o(21, oXk, oWk, gg);_(obk,ock);_(oak,obk);var odk = _n("view");_r(odk, 'class', 22, oXk, oWk, gg);var oek = _o(23, oXk, oWk, gg);_(odk,oek);_(oak,odk);_(oZk,oak);var ofk = _n("view");_r(ofk, 'class', 24, oXk, oWk, gg);var ogk = _o(25, oXk, oWk, gg);_(ofk,ogk);_(oZk,ofk);_(oUk,oZk);_(oVk, oUk);return oVk;};_2(15, oTk, e, s, gg, oSk, "item", "index", '{{item.id}}');_(oRk,oSk);_(oPk,oRk);_(oDk,oPk);_(r,oDk);
    return r;
  };
