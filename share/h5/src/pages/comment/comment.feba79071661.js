...
var z = [];
  ...
  var m0=function(e,s,r,gg){
    var o_H = _n("view");_r(o_H, 'class', 0, e, s, gg);var oAI = _n("view");_r(oAI, 'class', 1, e, s, gg);var oBI = _m( "view", ["bindtap", 2,"class", 1], e, s, gg);var oCI = _n("view");_r(oCI, 'class', 4, e, s, gg);var oDI = _o(5, e, s, gg);_(oCI,oDI);_(oBI,oCI);_(oAI,oBI);var oEI = _m( "view", ["bindtap", 2,"class", 4], e, s, gg);var oFI = _n("view");_r(oFI, 'class', 4, e, s, gg);var oGI = _o(7, e, s, gg);_(oFI,oGI);_(oEI,oFI);_(oAI,oEI);_(o_H,oAI);var oHI = _n("view");_r(oHI, 'class', 8, e, s, gg);var oII = _v();var oJI = function(oNI,oMI,oLI,gg){var oKI = _n("view");_r(oKI, 'class', 11, oNI, oMI, gg);var oPI = _n("view");_r(oPI, 'class', 12, oNI, oMI, gg);var oQI = _n("view");_r(oQI, 'class', 13, oNI, oMI, gg);var oRI = _n("image");_r(oRI, 'src', 14, oNI, oMI, gg);_(oQI,oRI);var oSI = _n("text");var oTI = _o(15, oNI, oMI, gg);_(oSI,oTI);_(oQI,oSI);_(oPI,oQI);var oUI = _n("view");_r(oUI, 'class', 16, oNI, oMI, gg);var oVI = _o(17, oNI, oMI, gg);_(oUI,oVI);_(oPI,oUI);_(oKI,oPI);var oWI = _n("view");_r(oWI, 'class', 18, oNI, oMI, gg);var oXI = _o(19, oNI, oMI, gg);_(oWI,oXI);_(oKI,oWI);var oYI = _v();
      if (_o(20, oNI, oMI, gg)) {
        oYI.wxVkey = 1;var oZI = _n("view");_r(oZI, 'class', 21, oNI, oMI, gg);var obI = _v();var ocI = function(ogI,ofI,oeI,gg){var odI = _m( "image", ["class", 25,"src", 1], ogI, ofI, gg);_(oeI, odI);return oeI;};_2(22, ocI, oNI, oMI, gg, obI, "pitem", "index", '{{pitem.id}}');_(oZI,obI);_(oYI, oZI);
      } _(oKI,oYI);var oiI = _n("view");_r(oiI, 'class', 27, oNI, oMI, gg);_(oKI,oiI);_(oLI, oKI);return oLI;};_2(9, oJI, e, s, gg, oII, "item", "index", '{{item.id}}');_(oHI,oII);_(o_H,oHI);_(r,o_H);
    return r;
  };
